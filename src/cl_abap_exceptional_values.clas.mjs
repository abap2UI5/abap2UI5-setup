...
class cl_abap_exceptional_values {
  ...
  static async get_max_value(INPUT) {
    ...
    if (abap.compare.eq(unique197, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_int)) {
      out.assign(abap.Classes['CL_ABAP_MATH'].max_int4);
    } else if (abap.compare.eq(unique197, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_packed)) {
