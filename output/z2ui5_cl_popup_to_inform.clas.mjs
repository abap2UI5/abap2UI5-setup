...
// z2ui5_cl_popup_to_inform.clas.abap
class z2ui5_cl_popup_to_inform {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_POPUP_TO_INFORM';
  ...
  "FACTORY": {"visibility": "U", "parameters": {"R_RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POPUP_TO_INFORM", RTTIName: "\\CLASS=Z2UI5_CL_POPUP_TO_INFORM"});}, "is_optional": " "}, "I_TEXT": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "I_TITLE": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "I_ICON": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "I_BUTTON_TEXT": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}}}};
  constructor() {
  ...
  async factory(INPUT) {
    return z2ui5_cl_popup_to_inform.factory(INPUT);
  }
  static async factory(INPUT) {
    let r_result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POPUP_TO_INFORM", RTTIName: "\\CLASS=Z2UI5_CL_POPUP_TO_INFORM"});
    ...
    r_result.set(await (new abap.Classes['Z2UI5_CL_POPUP_TO_INFORM']()).constructor_());
  ...
  async view_display() {
    ...
    popup.set((await (await (await (await (await (await (await (await (await (await (await abap.Classes['Z2UI5_CL_XML_VIEW'].factory_popup()).get().dialog({title: this.title, icon: this.icon, afterclose: (await this.client.get().z2ui5_if_client$_event({val: new abap.types.Character(14).set('BUTTON_CONFIRM')}))})).get().content()).get().vbox({class_: new abap.types.Character(17).set('sapUiMediumMargin')})).get().text({text: this.question_text})).get().get_parent()).get().get_parent()).get().footer()).get().overflow_toolbar()).get().toolbar_spacer()).get().button({text: this.button_text_confirm, press: (await this.client.get().z2ui5_if_client$_event({val: new abap.types.Character(14).set('BUTTON_CONFIRM')})), type: new abap.types.Character(10).set('Emphasized')})));
  ...
  async z2ui5_if_app$main(INPUT) {
    ...
    if (abap.compare.eq(unique184, new abap.types.String().set(`BUTTON_CONFIRM`))) {
...
abap.Classes['Z2UI5_CL_POPUP_TO_INFORM'] = z2ui5_cl_popup_to_inform;
z2ui5_cl_popup_to_inform.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_popup_to_inform.z2ui5_if_app$version.set('1.120.0');
z2ui5_cl_popup_to_inform.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_popup_to_inform.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_popup_to_inform.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_popup_to_inform.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_popup_to_inform};
//# sourceMappingURL=z2ui5_cl_popup_to_inform.clas.mjs.map