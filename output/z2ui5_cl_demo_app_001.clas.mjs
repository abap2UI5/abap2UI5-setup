...
// z2ui5_cl_demo_app_001.clas.abap
class z2ui5_cl_demo_app_001 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_001';
  ...
  async z2ui5_if_app$main(INPUT) {
    ...
    if (abap.compare.eq(this.check_initialized, abap.builtin.abap_false)) {
      ...
      await client.get().z2ui5_if_client$view_display({val: (await (await (await (await (await (await (await (await (await (await (await view.get().shell()).get().page({title: new abap.types.Character(24).set('abap2UI5 - First Example'), navbuttonpress: (await client.get().z2ui5_if_client$_event({val: new abap.types.Character(4).set('BACK'), s_ctrl: temp1})), shownavbutton: temp2})).get().simple_form({title: new abap.types.Character(10).set('Form Title'), editable: abap.builtin.abap_true})).get().content({ns: new abap.types.Character(4).set('form')})).get().title({text: new abap.types.Character(5).set('Input')})).get().label({text: new abap.types.Character(8).set('quantity')})).get().input({value: (await client.get().z2ui5_if_client$_bind_edit({val: this.quantity}))})).get().label({text: new abap.types.String().set(`product`)})).get().input({value: this.product, enabled: abap.builtin.abap_false})).get().button({text: new abap.types.Character(4).set('post'), press: (await client.get().z2ui5_if_client$_event({val: new abap.types.Character(11).set('BUTTON_POST')}))})).get().stringify())});
    }
    let unique189 = ((await client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique189, new abap.types.Character(11).set('BUTTON_POST'))) {
    ...
    } else if (abap.compare.eq(unique189, new abap.types.Character(4).set('BACK'))) {
      await client.get().z2ui5_if_client$nav_app_leave();
    }
  }
}
abap.Classes['Z2UI5_CL_DEMO_APP_001'] = z2ui5_cl_demo_app_001;
z2ui5_cl_demo_app_001.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_001.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_demo_app_001.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_001.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_demo_app_001.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_001.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_demo_app_001.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_001.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_demo_app_001};
//# sourceMappingURL=z2ui5_cl_demo_app_001.clas.mjs.map