...
// z2ui5_cx_abap_api.clas.abap
class z2ui5_cx_abap_api extends cx_no_check {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CX_ABAP_API';
  static IMPLEMENTED_INTERFACES = ["IF_MESSAGE","IF_MESSAGE"];
  static ATTRIBUTES = {"MS_ERROR": {"type": () => {return new abap.types.Structure({"x_root": new abap.types.ABAPObject({qualifiedName: "CX_ROOT", RTTIName: "\\CLASS=CX_ROOT"}), "text": new abap.types.String({qualifiedName: "STRING"})}, undefined, undefined, {}, {});}, "visibility": "U", "is_constant": " ", "is_class": " "}};
  ...
  constructor() {
    ...
    this.me.set(this);
    this.ms_error = new abap.types.Structure({"x_root": new abap.types.ABAPObject({qualifiedName: "CX_ROOT", RTTIName: "\\CLASS=CX_ROOT"}), "text": new abap.types.String({qualifiedName: "STRING"})}, undefined, undefined, {}, {});
  }
...
abap.Classes['Z2UI5_CX_ABAP_API'] = z2ui5_cx_abap_api;
export {z2ui5_cx_abap_api};
//# sourceMappingURL=z2ui5_cx_abap_api.clas.mjs.map