...
// z2ui5_cl_popup_table.clas.abap
class z2ui5_cl_popup_table {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_POPUP_TABLE';
  static IMPLEMENTED_INTERFACES = ["Z2UI5_IF_APP","IF_SERIALIZABLE_OBJECT"];
  static ATTRIBUTES = {"MS_RESULT": {"type": () => {return new abap.types.Structure({"row": new abap.types.DataReference(new abap.types.Character(4)), "check_confirmed": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"})}, "z2ui5_cl_popup_table=>ty_s_result", undefined, {}, {});}, "visibility": "U", "is_constant": " ", "is_class": " "},
  ...
  "FACTORY": {"visibility": "U", "parameters": {"R_RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POPUP_TABLE", RTTIName: "\\CLASS=Z2UI5_CL_POPUP_TABLE"});}, "is_optional": " "}, "I_TAB": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Character(4), {"withHeader":false,"keyType":"DEFAULT"});}, "is_optional": " "}}},
  "RESULT": {"visibility": "U", "parameters": {"RESULT": {"type": () => {return new abap.types.Structure({"row": new abap.types.DataReference(new abap.types.Character(4)), "check_confirmed": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"})}, "z2ui5_cl_popup_table=>ty_s_result", undefined, {}, {});}, "is_optional": " "}}}};
  constructor() {
    this.me = new abap.types.ABAPObject();
    this.me.set(this);
    this.ms_result = new abap.types.Structure({"row": new abap.types.DataReference(new abap.types.Character(4)), "check_confirmed": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"})}, "z2ui5_cl_popup_table=>ty_s_result", undefined, {}, {});
  ...
  async display() {
    ...
    popup.set((await (await (await abap.Classes['Z2UI5_CL_XML_VIEW'].factory_popup()).get().dialog({afterclose: (await this.client.get().z2ui5_if_client$_event({val: new abap.types.Character(14).set('BUTTON_CONFIRM')})), stretch: abap.builtin.abap_true, title: new abap.types.Character(10).set('Table View')})).get().content()));
    ...
    for await (const unique180 of abap.statements.loop(lt_comp)) {
      ls_comp.set(unique180);
  ...
  async factory(INPUT) {
    return z2ui5_cl_popup_table.factory(INPUT);
  }
  static async factory(INPUT) {
    let r_result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POPUP_TABLE", RTTIName: "\\CLASS=Z2UI5_CL_POPUP_TABLE"});
    let i_tab = INPUT?.i_tab;
    let fs_tab_ = new abap.types.FieldSymbol(new abap.types.Character(4));
    r_result.set(await (new abap.Classes['Z2UI5_CL_POPUP_TABLE']()).constructor_());
  ...
  async on_event() {
    let unique181 = ((await this.client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique181, new abap.types.Character(14).set('BUTTON_CONFIRM'))) {
      this.ms_result.get().check_confirmed.set(abap.builtin.abap_true);
      await this.on_event_confirm();
    } else if (abap.compare.eq(unique181, new abap.types.Character(6).set('CANCEL'))) {
  ...
  async result() {
    let result = new abap.types.Structure({"row": new abap.types.DataReference(new abap.types.Character(4)), "check_confirmed": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"})}, "z2ui5_cl_popup_table=>ty_s_result", undefined, {}, {});
...
abap.Classes['Z2UI5_CL_POPUP_TABLE'] = z2ui5_cl_popup_table;
z2ui5_cl_popup_table.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_popup_table.z2ui5_if_app$version.set('1.120.0');
z2ui5_cl_popup_table.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_popup_table.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_popup_table.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_popup_table.z2ui5_if_app$license.set('MIT');
z2ui5_cl_popup_table.ty_s_result = new abap.types.Structure({"row": new abap.types.DataReference(new abap.types.Character(4)), "check_confirmed": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"})}, "z2ui5_cl_popup_table=>ty_s_result", undefined, {}, {});
export {z2ui5_cl_popup_table};
//# sourceMappingURL=z2ui5_cl_popup_table.clas.mjs.map