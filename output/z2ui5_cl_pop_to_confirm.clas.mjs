...
// z2ui5_cl_pop_to_confirm.clas.abap
class z2ui5_cl_pop_to_confirm {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_POP_TO_CONFIRM';
  ...
  async factory(INPUT) {
    return z2ui5_cl_pop_to_confirm.factory(INPUT);
  }
  static async factory(INPUT) {
    let r_result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POP_TO_CONFIRM", RTTIName: "\\CLASS=Z2UI5_CL_POP_TO_CONFIRM"});
    ...
    r_result.set(await (new abap.Classes['Z2UI5_CL_POP_TO_CONFIRM']()).constructor_());
  ...
  async view_display() {
    ...
    popup.set((await (await (await (await (await (await (await (await (await (await abap.Classes['Z2UI5_CL_XML_VIEW'].factory_popup()).get().dialog({title: this.title, icon: this.icon, afterclose: (await this.client.get().z2ui5_if_client$_event({val: new abap.types.Character(13).set('BUTTON_CANCEL')}))})).get().content()).get().vbox({class: new abap.types.Character(17).set('sapUiMediumMargin')})).get().text({text: this.question_text})).get().get_parent()).get().get_parent()).get().buttons()).get().button({text: this.button_text_cancel, press: (await this.client.get().z2ui5_if_client$_event({val: new abap.types.Character(13).set('BUTTON_CANCEL')}))})).get().button({text: this.button_text_confirm, press: (await this.client.get().z2ui5_if_client$_event({val: new abap.types.Character(14).set('BUTTON_CONFIRM')})), type: new abap.types.Character(10).set('Emphasized')})));
...
abap.Classes['Z2UI5_CL_POP_TO_CONFIRM'] = z2ui5_cl_pop_to_confirm;
z2ui5_cl_pop_to_confirm.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_to_confirm.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_pop_to_confirm.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_to_confirm.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_pop_to_confirm.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_to_confirm.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_pop_to_confirm.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_to_confirm.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_pop_to_confirm};
//# sourceMappingURL=z2ui5_cl_pop_to_confirm.clas.mjs.map