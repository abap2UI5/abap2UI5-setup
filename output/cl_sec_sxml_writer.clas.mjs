...
class cl_sec_sxml_writer {
  ...
  static async crypt_aes_ctr(INPUT) {
    ...
    let unique735 = algorithm;
    if (abap.compare.eq(unique735, cl_sec_sxml_writer.co_aes128_algorithm)) {
      lv_algo.set(new abap.types.Character(11).set('aes-128-ctr'));
    } else if (abap.compare.eq(unique735, cl_sec_sxml_writer.co_aes256_algorithm)) {
