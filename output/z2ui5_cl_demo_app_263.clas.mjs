...
// z2ui5_cl_demo_app_263.clas.abap
class z2ui5_cl_demo_app_263 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_263';
  ...
  async display_view(INPUT) {
    ...
    page.set((await (await (await abap.Classes['Z2UI5_CL_XML_VIEW'].factory()).get().shell()).get().page({title: new abap.types.Character(44).set('abap2UI5 - Sample: Numeric Content with Icon'), navbuttonpress: (await client.get().z2ui5_if_client$_event({val: new abap.types.Character(4).set('BACK')})), shownavbutton: temp1})));
    ...
    await (await page.get().header_content()).get().link({text: new abap.types.Character(12).set('UI5 Demo Kit'), target: new abap.types.Character(6).set('_blank'), href: new abap.types.Character(105).set('https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.NumericContent/sample/sap.m.sample.NumericContentIcon')});
    await page.get().numeric_content({value: new abap.types.String().set(`65`), scale: new abap.types.String().set(`MM`), valuecolor: new abap.types.String().set(`Error`), indicator: new abap.types.String().set(`Down`), icon: new abap.types.String().set(`sap-icon://travel-expense`), class: new abap.types.String().set(`sapUiSmallMargin`), press: (await client.get().z2ui5_if_client$_event({val: new abap.types.Character(5).set('press')}))});
    await page.get().numeric_content({value: new abap.types.String().set(`11`), scale: new abap.types.String().set(`MM`), valuecolor: new abap.types.String().set(`Critical`), indicator: new abap.types.String().set(`Up`), icon: new abap.types.String().set(`test-resources/sap/m/demokit/sample/NumericContentIcon/images/grass.jpg`), class: new abap.types.String().set(`sapUiSmallMargin`), press: (await client.get().z2ui5_if_client$_event({val: new abap.types.Character(5).set('press')}))});
  ...
  async on_event(INPUT) {
    ...
    if (client?.getQualifiedName === undefined || client.getQualifiedName() !== "Z2UI5_IF_CLIENT") { client = undefined; }
    if (client === undefined) { client = new abap.types.ABAPObject({qualifiedName: "Z2UI5_IF_CLIENT", RTTIName: "\\INTERFACE=Z2UI5_IF_CLIENT"}).set(INPUT.client); }
    let unique559 = ((await client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique559, new abap.types.Character(4).set('BACK'))) {
      await client.get().z2ui5_if_client$nav_app_leave();
    } else if (abap.compare.eq(unique559, new abap.types.Character(5).set('press'))) {
      await client.get().z2ui5_if_client$message_toast_display({text: new abap.types.String().set(`The numeric content is pressed.`)});
    } else if (abap.compare.eq(unique559, new abap.types.Character(7).set('POPOVER'))) {
...
abap.Classes['Z2UI5_CL_DEMO_APP_263'] = z2ui5_cl_demo_app_263;
z2ui5_cl_demo_app_263.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_263.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_demo_app_263.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_263.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_demo_app_263.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_263.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_demo_app_263.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_263.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_demo_app_263};
//# sourceMappingURL=z2ui5_cl_demo_app_263.clas.mjs.map