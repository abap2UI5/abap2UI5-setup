...
class cl_message_helper {
  ...
  static async set_msg_vars_for_if_msg(INPUT) {
    ...
    if (abap.compare.initial(text)) {
      const unique619 = await (new abap.Classes['CX_SY_MESSAGE_ILLEGAL_TEXT']()).constructor_();
      unique619.EXTRA_CX = {"INTERNAL_FILENAME": "cl_message_helper.clas.abap","INTERNAL_LINE": 76};
      throw unique619;
    }
