...
class cl_abap_tstmp {
  ...
  static async systemtstmp_syst2utc(INPUT) {
    ...
    if (abap.compare.initial(syst_date)) {
      const unique631 = await (new abap.Classes['CX_PARAMETER_INVALID_RANGE']()).constructor_();
      unique631.EXTRA_CX = {"INTERNAL_FILENAME": "cl_abap_tstmp.clas.abap","INTERNAL_LINE": 98};
      throw unique631;
    }
