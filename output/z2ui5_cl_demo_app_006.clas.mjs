...
// z2ui5_cl_demo_app_006.clas.abap
class z2ui5_cl_demo_app_006 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_006';
  static IMPLEMENTED_INTERFACES = ["Z2UI5_IF_APP","IF_SERIALIZABLE_OBJECT"];
  static ATTRIBUTES = {"T_TAB": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({"count": new abap.types.Integer({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-COUNT"}), "value": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-VALUE"}), "descr": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-DESCR"}), "icon": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-ICON"}), "info": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-INFO"}), "checkbox": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}), "percentage": new abap.types.Packed({length: 5, decimals: 2, qualifiedName: "z2ui5_cl_demo_app_006=>ty_row-percentage"}), "valuecolor": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-VALUECOLOR"})}, "z2ui5_cl_demo_app_006=>ty_row", undefined, {}, {}), {"withHeader":false,"keyType":"DEFAULT","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "z2ui5_cl_demo_app_006=>temp1_9d87ec7b26");}, "visibility": "U", "is_constant": " ", "is_class": " "},
  ...
  constructor() {
    ...
    this.me.set(this);
    this.t_tab = abap.types.TableFactory.construct(new abap.types.Structure({"count": new abap.types.Integer({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-COUNT"}), "value": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-VALUE"}), "descr": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-DESCR"}), "icon": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-ICON"}), "info": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-INFO"}), "checkbox": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}), "percentage": new abap.types.Packed({length: 5, decimals: 2, qualifiedName: "z2ui5_cl_demo_app_006=>ty_row-percentage"}), "valuecolor": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-VALUECOLOR"})}, "z2ui5_cl_demo_app_006=>ty_row", undefined, {}, {}), {"withHeader":false,"keyType":"DEFAULT","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "z2ui5_cl_demo_app_006=>temp1_9d87ec7b26");
  ...
  async refresh_data() {
    let ls_row = new abap.types.Structure({"count": new abap.types.Integer({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-COUNT"}), "value": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-VALUE"}), "descr": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-DESCR"}), "icon": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-ICON"}), "info": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-INFO"}), "checkbox": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}), "percentage": new abap.types.Packed({length: 5, decimals: 2, qualifiedName: "z2ui5_cl_demo_app_006=>ty_row-percentage"}), "valuecolor": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-VALUECOLOR"})}, "z2ui5_cl_demo_app_006=>ty_row", undefined, {}, {});
    const indexBackup1 = abap.builtin.sy.get().index.get();
    const unique195 = new abap.types.Integer().set(10000).get();
    for (let unique196 = 0; unique196 < unique195; unique196++) {
      abap.builtin.sy.get().index.set(unique196 + 1);
  ...
  async z2ui5_if_app$main(INPUT) {
    ...
    let unique197 = ((await client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique197, new abap.types.Character(14).set('SORT_ASCENDING'))) {
    ...
    } else if (abap.compare.eq(unique197, new abap.types.Character(15).set('SORT_DESCENDING'))) {
    ...
    } else if (abap.compare.eq(unique197, new abap.types.Character(4).set('BACK'))) {
...
abap.Classes['Z2UI5_CL_DEMO_APP_006'] = z2ui5_cl_demo_app_006;
z2ui5_cl_demo_app_006.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_006.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_demo_app_006.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_006.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_demo_app_006.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_006.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_demo_app_006.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_006.z2ui5_if_app$license.set('MIT');
z2ui5_cl_demo_app_006.ty_row = new abap.types.Structure({"count": new abap.types.Integer({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-COUNT"}), "value": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-VALUE"}), "descr": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-DESCR"}), "icon": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-ICON"}), "info": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-INFO"}), "checkbox": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}), "percentage": new abap.types.Packed({length: 5, decimals: 2, qualifiedName: "z2ui5_cl_demo_app_006=>ty_row-percentage"}), "valuecolor": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-VALUECOLOR"})}, "z2ui5_cl_demo_app_006=>ty_row", undefined, {}, {});
z2ui5_cl_demo_app_006.temp1_9d87ec7b26 = abap.types.TableFactory.construct(new abap.types.Structure({"count": new abap.types.Integer({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-COUNT"}), "value": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-VALUE"}), "descr": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-DESCR"}), "icon": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-ICON"}), "info": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-INFO"}), "checkbox": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}), "percentage": new abap.types.Packed({length: 5, decimals: 2, qualifiedName: "z2ui5_cl_demo_app_006=>ty_row-percentage"}), "valuecolor": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_006=>TY_ROW-VALUECOLOR"})}, "z2ui5_cl_demo_app_006=>ty_row", undefined, {}, {}), {"withHeader":false,"keyType":"DEFAULT","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "z2ui5_cl_demo_app_006=>temp1_9d87ec7b26");
export {z2ui5_cl_demo_app_006};
//# sourceMappingURL=z2ui5_cl_demo_app_006.clas.mjs.map