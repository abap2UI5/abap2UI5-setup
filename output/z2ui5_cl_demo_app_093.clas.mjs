...
// z2ui5_cl_demo_app_093.clas.abap
class z2ui5_cl_demo_app_093 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_093';
  ...
  async z2ui5_if_app$main(INPUT) {
    ...
    if (abap.compare.eq(this.check_initialized, abap.builtin.abap_false)) {
      ...
      await (await view.get()._generic({ns: new abap.types.String().set(`html`), name: new abap.types.String().set(`script`)})).get()._cc_plain_xml({val: new abap.types.String().set(`sap.z2ui5.myFunction();`)});
    ...
    let unique326 = ((await client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique326, new abap.types.Character(11).set('BUTTON_POST'))) {
    ...
    } else if (abap.compare.eq(unique326, new abap.types.Character(4).set('BACK'))) {
...
abap.Classes['Z2UI5_CL_DEMO_APP_093'] = z2ui5_cl_demo_app_093;
z2ui5_cl_demo_app_093.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_093.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_demo_app_093.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_093.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_demo_app_093.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_093.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_demo_app_093.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_093.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_demo_app_093};
//# sourceMappingURL=z2ui5_cl_demo_app_093.clas.mjs.map