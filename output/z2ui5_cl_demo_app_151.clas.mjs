...
// z2ui5_cl_demo_app_151.clas.abap
class z2ui5_cl_demo_app_151 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_151';
  ...
  async ui5_event() {
    let lo_app = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POP_TO_INFORM", RTTIName: "\\CLASS=Z2UI5_CL_POP_TO_INFORM"});
    let unique406 = ((await this.client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique406, new abap.types.Character(5).set('POPUP'))) {
      lo_app.set((await abap.Classes['Z2UI5_CL_POP_TO_INFORM'].factory({i_text: new abap.types.String().set(`this is a question`)})));
      await this.client.get().z2ui5_if_client$nav_app_call({app: lo_app});
    } else if (abap.compare.eq(unique406, new abap.types.Character(4).set('BACK'))) {
...
abap.Classes['Z2UI5_CL_DEMO_APP_151'] = z2ui5_cl_demo_app_151;
z2ui5_cl_demo_app_151.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_151.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_demo_app_151.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_151.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_demo_app_151.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_151.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_demo_app_151.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_151.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_demo_app_151};
//# sourceMappingURL=z2ui5_cl_demo_app_151.clas.mjs.map