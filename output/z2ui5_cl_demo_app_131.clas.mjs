...
// z2ui5_cl_demo_app_131.clas.abap
class z2ui5_cl_demo_app_131 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_131';
  ...
  "MT_T002": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({"id": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-ID"}), "count": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-COUNT"}), "table": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-TABLE"}), "class": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-CLASS"})}, "z2ui5_cl_demo_app_131=>ty_s_t002", undefined, {}, {}), {"withHeader":false,"keyType":"DEFAULT","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "z2ui5_cl_demo_app_131=>ty_t_t002");}, "visibility": "U", "is_constant": " ", "is_class": " "},
  ...
  constructor() {
    ...
    this.mt_t002 = abap.types.TableFactory.construct(new abap.types.Structure({"id": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-ID"}), "count": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-COUNT"}), "table": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-TABLE"}), "class": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-CLASS"})}, "z2ui5_cl_demo_app_131=>ty_s_t002", undefined, {}, {}), {"withHeader":false,"keyType":"DEFAULT","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "z2ui5_cl_demo_app_131=>ty_t_t002");
  ...
  async on_event() {
    let unique377 = ((await this.client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique377, new abap.types.Character(18).set('ONSELECTICONTABBAR'))) {
      let unique378 = this.mv_selectedkey;
      if (abap.compare.eq(unique378, abap.builtin.space)) {
      } else {
      }
    } else if (abap.compare.eq(unique377, new abap.types.Character(4).set('BACK'))) {
    }
  }
  async on_init() {
    let temp1 = abap.types.TableFactory.construct(new abap.types.Structure({"id": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-ID"}), "count": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-COUNT"}), "table": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-TABLE"}), "class": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-CLASS"})}, "z2ui5_cl_demo_app_131=>ty_s_t002", undefined, {}, {}), {"withHeader":false,"keyType":"DEFAULT","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "z2ui5_cl_demo_app_131=>ty_t_t002");
    let temp2 = new abap.types.Structure({"id": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-ID"}), "count": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-COUNT"}), "table": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-TABLE"}), "class": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-CLASS"})}, "z2ui5_cl_demo_app_131=>ty_s_t002", undefined, {}, {});
    abap.statements.clear(temp1);
    temp2.get().id.set(new abap.types.Character(1).set('1'));
    temp2.get().class.set(new abap.types.Character(21).set('Z2UI5_CL_DEMO_APP_132'));
    temp2.get().count.set(new abap.types.Character(2).set('12'));
    abap.statements.insertInternal({data: temp2, table: temp1});
    temp2.get().id.set(new abap.types.Character(1).set('2'));
    temp2.get().class.set(new abap.types.Character(21).set('Z2UI5_CL_DEMO_APP_132'));
    temp2.get().count.set(new abap.types.Character(2).set('80'));
    abap.statements.insertInternal({data: temp2, table: temp1});
  ...
  async render_main() {
    ...
    let temp3 = new abap.types.Structure({"id": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-ID"}), "count": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-COUNT"}), "table": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-TABLE"}), "class": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-CLASS"})}, "z2ui5_cl_demo_app_131=>ty_s_t002", undefined, {}, {});
    let line = new abap.types.DataReference(new abap.types.Structure({"id": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-ID"}), "count": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-COUNT"}), "table": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-TABLE"}), "class": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-CLASS"})}, "z2ui5_cl_demo_app_131=>ty_s_t002", undefined, {}, {}));
    ...
    for await (const unique379 of abap.statements.loop(this.mt_t002)) {
      line.assign(unique379);
  ...
  async render_sub_app() {
    ...
    let unique380 = this.mv_selectedkey;
    if (abap.compare.ne(this.mv_selectedkey, this.mv_selectedkey_tmp)) {
      let unique381 = abap.Classes["CLAS-Z2UI5_CL_DEMO_APP_131-"+t002.get().class.get().trimEnd()];
      if (unique381 === undefined) { unique381 = abap.Classes[t002.get().class.get().trimEnd()]; }
      if (unique381 === undefined) { throw new abap.Classes['CX_SY_CREATE_OBJECT_ERROR']; }
      this.mo_app.set(await (new unique381()).constructor_());
    }
    try {
    ...
    abap.Classes['Z2UI5_CL_DEMO_APP_131'] = z2ui5_cl_demo_app_131;
    z2ui5_cl_demo_app_131.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
    z2ui5_cl_demo_app_131.z2ui5_if_app$version.set('1.135.0');
    z2ui5_cl_demo_app_131.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
    z2ui5_cl_demo_app_131.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
    z2ui5_cl_demo_app_131.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
    z2ui5_cl_demo_app_131.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
    z2ui5_cl_demo_app_131.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
    z2ui5_cl_demo_app_131.z2ui5_if_app$license.set('MIT');
    z2ui5_cl_demo_app_131.ty_s_t002 = new abap.types.Structure({"id": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-ID"}), "count": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-COUNT"}), "table": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-TABLE"}), "class": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-CLASS"})}, "z2ui5_cl_demo_app_131=>ty_s_t002", undefined, {}, {});
    z2ui5_cl_demo_app_131.ty_t_t002 = abap.types.TableFactory.construct(new abap.types.Structure({"id": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-ID"}), "count": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-COUNT"}), "table": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-TABLE"}), "class": new abap.types.String({qualifiedName: "Z2UI5_CL_DEMO_APP_131=>TY_S_T002-CLASS"})}, "z2ui5_cl_demo_app_131=>ty_s_t002", undefined, {}, {}), {"withHeader":false,"keyType":"DEFAULT","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "z2ui5_cl_demo_app_131=>ty_t_t002");
export {z2ui5_cl_demo_app_131};
//# sourceMappingURL=z2ui5_cl_demo_app_131.clas.mjs.map