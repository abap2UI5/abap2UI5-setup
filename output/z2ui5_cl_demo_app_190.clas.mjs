...
// z2ui5_cl_demo_app_190.clas.abap
class z2ui5_cl_demo_app_190 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_190';
  ...
  async on_event() {
    ...
    let unique457 = ((await this.client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique457, new abap.types.Character(4).set('BACK'))) {
  ...
  async render_main() {
    ...
    for await (const unique458 of abap.statements.loop(this.mt_comp)) {
      comp.set(unique458);
    ...
    for await (const unique459 of abap.statements.loop(this.mt_comp)) {
      comp.set(unique459);
  ...
  async get_fixval() {
    ...
    for await (const unique460 of abap.statements.loop(this.mt_comp)) {
      dfies.assign(unique460);
      abap.statements.clear(temp2);
      temp2.set(comp);
      temp3.get().name.set(dfies.get().name);
      await abap.statements.cast(temp4, (await abap.Classes['CL_ABAP_DATADESCR'].describe_by_data({p_data: lt_fixval})));
  ...
  async get_comp() {
    ...
    let temp4 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_STRUCTDESCR", RTTIName: "\\CLASS=CL_ABAP_STRUCTDESCR"});
    ...
    let temp7 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR", RTTIName: "\\CLASS=CL_ABAP_DATADESCR"});
    ...
    try {
      try {
        try {
          ...
          await abap.statements.cast(temp4, typedesc);
          structdesc.set(temp4);
          comp.set((await structdesc.get().get_components()));
          for await (const unique461 of abap.statements.loop(comp)) {
            com.set(unique461);
        ...
        temp6.get().name.set(new abap.types.Character(6).set('ROW_ID'));
        await abap.statements.cast(temp7, (await abap.Classes['CL_ABAP_DATADESCR'].describe_by_data({p_data: index})));
        temp6.get().type.set(temp7);
  ...
  abap.Classes['Z2UI5_CL_DEMO_APP_190'] = z2ui5_cl_demo_app_190;
  z2ui5_cl_demo_app_190.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
  z2ui5_cl_demo_app_190.z2ui5_if_app$version.set('1.135.0');
  z2ui5_cl_demo_app_190.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
  z2ui5_cl_demo_app_190.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
  z2ui5_cl_demo_app_190.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
  z2ui5_cl_demo_app_190.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
  z2ui5_cl_demo_app_190.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
  z2ui5_cl_demo_app_190.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_demo_app_190};
//# sourceMappingURL=z2ui5_cl_demo_app_190.clas.mjs.map