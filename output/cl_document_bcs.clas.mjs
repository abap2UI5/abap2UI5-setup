...
class cl_document_bcs {
  ...
  "ADD_ATTACHMENT": {"visibility": "U", "parameters": {"I_ATTACHMENT_TYPE": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "I_ATTACHMENT_SUBJECT": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "I_ATTACHMENT_SIZE": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "I_ATT_CONTENT_TEXT": {"type": () => {return new abap.types.Character(4);}, "is_optional": " "}, "I_ATT_CONTENT_HEX": {"type": () => {return new abap.types.Character(4);}, "is_optional": " "}, "I_ATTACHMENT_HEADER": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({"line": new abap.types.Character(255, {"qualifiedName":"SO_TEXT255","ddicName":"SO_TEXT255"})}, "SOLI", "SOLI", {}, {}), {"withHeader":false,"keyType":"DEFAULT","primaryKey":{"isUnique":false,"type":"STANDARD","keyFields":[],"name":"primary_key"},"secondary":[]}, "SOLI_TAB");}, "is_optional": " "}}}};
  constructor() {
