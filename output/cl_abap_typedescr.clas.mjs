...
class cl_abap_typedescr {
  ...
  static async describe_by_dashes(INPUT) {
    ...
    for await (const unique729 of abap.statements.loop(lt_parts)) {
      lv_part.set(unique729);
  ...
  static async describe_by_name(INPUT) {
    ...
    let unique730 = oo_type;
    if (abap.compare.eq(unique730, new abap.types.Character(4).set('INTF'))) {
    ...
    } else if (abap.compare.eq(unique730, new abap.types.Character(4).set('CLAS'))) {
  ...
  static async is_deep(INPUT) {
    ...
    for await (const unique731 of abap.statements.loop(lt_components)) {
      fs_ls_component_.assign(unique731);
  ...
  static async describe_by_data(INPUT) {
    ...
    let unique732 = lv_name;
    if (abap.compare.eq(unique732, new abap.types.Character(7).set('Integer'))) {
    ...
    } else if (abap.compare.eq(unique732, new abap.types.Character(8).set('Integer8'))) {
      type.set(await (new abap.Classes['CL_ABAP_ELEMDESCR']()).constructor_());
    ...
    } else if (abap.compare.eq(unique732, new abap.types.Character(4).set('Numc'))) {
      type.set(await (new abap.Classes['CL_ABAP_ELEMDESCR']()).constructor_());
    ...
    } else if (abap.compare.eq(unique732, new abap.types.Character(3).set('Hex')) || abap.compare.eq(unique732, new abap.types.Character(8).set('HexUInt8'))) {
      type.set(await (new abap.Classes['CL_ABAP_ELEMDESCR']()).constructor_());
    ...
    } else if (abap.compare.eq(unique732, new abap.types.Character(4).set('Date'))) {
      type.set(await (new abap.Classes['CL_ABAP_ELEMDESCR']()).constructor_());
    ...
    } else if (abap.compare.eq(unique732, new abap.types.Character(6).set('Packed'))) {
      type.set(await (new abap.Classes['CL_ABAP_ELEMDESCR']()).constructor_());
      type.get().type_kind.set(cl_abap_typedescr.typekind_packed);
      type.get().kind.set(cl_abap_typedescr.kind_elem);
      type.get().length.set(lv_length);
      type.get().decimals.set(lv_decimals);
    } else if (abap.compare.eq(unique732, new abap.types.Character(4).set('Time'))) {
      type.set(await (new abap.Classes['CL_ABAP_ELEMDESCR']()).constructor_());
    ...
    } else if (abap.compare.eq(unique732, new abap.types.Character(5).set('Float'))) {
      type.set(await (new abap.Classes['CL_ABAP_ELEMDESCR']()).constructor_());
      type.get().type_kind.set(cl_abap_typedescr.typekind_float);
      type.get().kind.set(cl_abap_typedescr.kind_elem);
      type.get().absolute_name.set(new abap.types.Character(1).set('F'));
    } else if (abap.compare.eq(unique732, new abap.types.Character(10).set('DecFloat34'))) {
      type.set(await (new abap.Classes['CL_ABAP_ELEMDESCR']()).constructor_());
      type.get().type_kind.set(cl_abap_typedescr.typekind_decfloat34);
      type.get().kind.set(cl_abap_typedescr.kind_elem);
    } else if (abap.compare.eq(unique732, new abap.types.Character(9).set('Structure'))) {
    ...
    } else if (abap.compare.eq(unique732, new abap.types.Character(5).set('Table')) || abap.compare.eq(unique732, new abap.types.Character(11).set('HashedTable'))) {
      ...
      type.get().length.set(abap.IntegerFactory.get(8));
    } else if (abap.compare.eq(unique732, new abap.types.Character(7).set('XString'))) {
      type.set(await (new abap.Classes['CL_ABAP_ELEMDESCR']()).constructor_());
    ...
    } else if (abap.compare.eq(unique732, new abap.types.Character(6).set('String'))) {
      type.set(await (new abap.Classes['CL_ABAP_ELEMDESCR']()).constructor_());
      type.get().type_kind.set(cl_abap_typedescr.typekind_string);
      type.get().kind.set(cl_abap_typedescr.kind_elem);
      type.get().length.set(abap.IntegerFactory.get(8));
      type.get().absolute_name.set(new abap.types.Character(6).set('STRING'));
    } else if (abap.compare.eq(unique732, new abap.types.Character(9).set('Character'))) {
      type.set(await (new abap.Classes['CL_ABAP_ELEMDESCR']()).constructor_());
      ...
      await abap.statements.cast(lo_elem, type);
      lo_elem.get().output_length.set(lv_length);
    } else if (abap.compare.eq(unique732, new abap.types.Character(11).set('FieldSymbol'))) {
      lv_name = p_data.getPointer();
      type.set((await this.describe_by_data({p_data: lv_name})));
      return type;
    } else if (abap.compare.eq(unique732, new abap.types.Character(10).set('ABAPObject'))) {
    ...
    } else if (abap.compare.eq(unique732, new abap.types.Character(7).set('UTCLong'))) {
      type.set(await (new abap.Classes['CL_ABAP_ELEMDESCR']()).constructor_());
      type.get().type_kind.set(cl_abap_typedescr.typekind_utclong);
      type.get().kind.set(cl_abap_typedescr.kind_elem);
    } else if (abap.compare.eq(unique732, new abap.types.Character(13).set('DataReference'))) {
      type.set(await (new abap.Classes['CL_ABAP_REFDESCR']()).constructor_());
