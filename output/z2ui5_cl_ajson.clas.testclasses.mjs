...
class ltcl_json_to_abap {
  ...
  "TO_ABAP_STR_TO_PACKED": {"visibility": "I", "parameters": {}},
  "TO_ABAP_COMPRESSED_STDRD": {"visibility": "I", "parameters": {}},
  "TO_ABAP_COMPRESSED_STDRD_KEY": {"visibility": "I", "parameters": {}},
  "TO_ABAP_COMPRESSED_SORT": {"visibility": "I", "parameters": {}},
  "TO_ABAP_COMPRESSED_SORT_UNIQUE": {"visibility": "I", "parameters": {}},
  "TO_ABAP_COMPRESSED_HASH": {"visibility": "I", "parameters": {}}};
  constructor() {
    this.me = new abap.types.ABAPObject();
    this.me.set(this);
  }
  ...
  async to_abap_struc() {
    ...
    await lo_nodes.get().add({iv_str: new abap.types.Character(56).set('/      |timestamp4 |str    |2020-07-28T01:00:00+01:00 | ')});
    ...
    ls_exp.get().timestamp4.set(lv_exp_timestamp);
  ...
  async to_abap_time() {
    ...
    let lo_nodes = new abap.types.ABAPObject({qualifiedName: "LCL_NODES_HELPER", RTTIName: "\\CLASS-POOL=Z2UI5_CL_AJSON\\CLASS=LCL_NODES_HELPER"});
    let lv_mock_init = new abap.types.Time({qualifiedName: "T"});
    lo_nodes.set(await (new abap.Classes['CLAS-Z2UI5_CL_AJSON-LCL_NODES_HELPER']()).constructor_());
    ...
    lo_nodes.set(await (new abap.Classes['CLAS-Z2UI5_CL_AJSON-LCL_NODES_HELPER']()).constructor_());
    await lo_nodes.get().add({iv_str: new abap.types.Character(30).set('       |           |str    || ')});
    lo_cut.set(await (new abap.Classes['CLAS-Z2UI5_CL_AJSON-LCL_JSON_TO_ABAP']()).constructor_());
    await lo_cut.get().to_abap({it_nodes: (await lo_nodes.get().sorted()), c_container: lv_mock_init});
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({act: lv_mock_init, exp: new abap.types.Character(6).set('000000')});
  }
  async to_abap_str_to_packed() {
    let lo_cut = new abap.types.ABAPObject({qualifiedName: "LCL_JSON_TO_ABAP", RTTIName: "\\CLASS-POOL=Z2UI5_CL_AJSON\\CLASS=LCL_JSON_TO_ABAP"});
    let lv_act = new abap.types.Packed({length: 10, decimals: 3});
    let lo_nodes = new abap.types.ABAPObject({qualifiedName: "LCL_NODES_HELPER", RTTIName: "\\CLASS-POOL=Z2UI5_CL_AJSON\\CLASS=LCL_NODES_HELPER"});
    lo_nodes.set(await (new abap.Classes['CLAS-Z2UI5_CL_AJSON-LCL_NODES_HELPER']()).constructor_());
    await lo_nodes.get().add({iv_str: new abap.types.Character(56).set('       |           |str    |1.3333                    | ')});
    lo_cut.set(await (new abap.Classes['CLAS-Z2UI5_CL_AJSON-LCL_JSON_TO_ABAP']()).constructor_());
    await lo_cut.get().to_abap({it_nodes: (await lo_nodes.get().sorted()), c_container: lv_act});
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({act: lv_act, exp: new abap.types.Character(5).set('1.333')});
  }
  async to_abap_value() {
    let lo_cut = new abap.types.ABAPObject({qualifiedName: "LCL_JSON_TO_ABAP", RTTIName: "\\CLASS-POOL=Z2UI5_CL_AJSON\\CLASS=LCL_JSON_TO_ABAP"});
  ...
  async to_abap_compressed_stdrd() {
    let lt_foo_bar = abap.types.TableFactory.construct(new abap.types.Structure({"foo": new abap.types.String({qualifiedName: "TY_FOO_BAR-FOO"}), "bar": new abap.types.String({qualifiedName: "TY_FOO_BAR-BAR"})}, "ty_foo_bar", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "");
    let ls_foo_bar = new abap.types.Structure({"foo": new abap.types.String({qualifiedName: "TY_FOO_BAR-FOO"}), "bar": new abap.types.String({qualifiedName: "TY_FOO_BAR-BAR"})}, "ty_foo_bar", undefined, {}, {});
    ...
    lv_json.set(abap.operators.concat(new abap.types.Character(1).set('['),abap.operators.concat(new abap.types.Character(3).set('  {'),abap.operators.concat(new abap.types.Character(17).set('    "foo": "abc",'),abap.operators.concat(new abap.types.Character(16).set('    "bar": "123"'),abap.operators.concat(new abap.types.Character(4).set('  },'),abap.operators.concat(new abap.types.Character(3).set('  {'),abap.operators.concat(new abap.types.Character(16).set('    "foo": "cde"'),abap.operators.concat(new abap.types.Character(3).set('  }'),new abap.types.Character(1).set(']'))))))))));
    lo_ajson.set((await abap.Classes['Z2UI5_CL_AJSON'].parse({iv_json: lv_json})));
    await lo_ajson.get().z2ui5_if_ajson$to_abap({ev_container: lt_foo_bar});
    abap.statements.readTable(lt_foo_bar,{into: ls_foo_bar,
      withKey: (i) => {return abap.compare.eq(i.foo, new abap.types.Character(3).set('cde'));},
      withKeyValue: [{key: (i) => {return i.foo}, value: new abap.types.Character(3).set('cde')}],
      usesTableLine: false,
      withKeySimple: {"foo": new abap.types.Character(3).set('cde')}});
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_initial({act: ls_foo_bar.get().bar});
  }
  async to_abap_compressed_stdrd_key() {
    let lt_foo_bar = abap.types.TableFactory.construct(new abap.types.Structure({"foo": new abap.types.String({qualifiedName: "TY_FOO_BAR-FOO"}), "bar": new abap.types.String({qualifiedName: "TY_FOO_BAR-BAR"})}, "ty_foo_bar", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["FOO"]},"secondary":[]}, "");
    let ls_foo_bar = new abap.types.Structure({"foo": new abap.types.String({qualifiedName: "TY_FOO_BAR-FOO"}), "bar": new abap.types.String({qualifiedName: "TY_FOO_BAR-BAR"})}, "ty_foo_bar", undefined, {}, {});
    let lo_ajson = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_AJSON", RTTIName: "\\CLASS=Z2UI5_CL_AJSON"});
    let lv_json = new abap.types.String({qualifiedName: "STRING"});
    lv_json.set(abap.operators.concat(new abap.types.Character(1).set('['),abap.operators.concat(new abap.types.Character(3).set('  {'),abap.operators.concat(new abap.types.Character(17).set('    "foo": "abc",'),abap.operators.concat(new abap.types.Character(16).set('    "bar": "123"'),abap.operators.concat(new abap.types.Character(4).set('  },'),abap.operators.concat(new abap.types.Character(3).set('  {'),abap.operators.concat(new abap.types.Character(16).set('    "foo": "cde"'),abap.operators.concat(new abap.types.Character(3).set('  }'),new abap.types.Character(1).set(']'))))))))));
  ...
  async to_abap_compressed_sort() {
    let lt_foo_bar = abap.types.TableFactory.construct(new abap.types.Structure({"foo": new abap.types.String({qualifiedName: "TY_FOO_BAR-FOO"}), "bar": new abap.types.String({qualifiedName: "TY_FOO_BAR-BAR"})}, "ty_foo_bar", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"SORTED","isUnique":false,"keyFields":["FOO"]},"secondary":[]}, "");
    let ls_foo_bar = new abap.types.Structure({"foo": new abap.types.String({qualifiedName: "TY_FOO_BAR-FOO"}), "bar": new abap.types.String({qualifiedName: "TY_FOO_BAR-BAR"})}, "ty_foo_bar", undefined, {}, {});
    let lo_ajson = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_AJSON", RTTIName: "\\CLASS=Z2UI5_CL_AJSON"});
    let lv_json = new abap.types.String({qualifiedName: "STRING"});
    lv_json.set(abap.operators.concat(new abap.types.Character(1).set('['),abap.operators.concat(new abap.types.Character(3).set('  {'),abap.operators.concat(new abap.types.Character(17).set('    "foo": "abc",'),abap.operators.concat(new abap.types.Character(16).set('    "bar": "123"'),abap.operators.concat(new abap.types.Character(4).set('  },'),abap.operators.concat(new abap.types.Character(3).set('  {'),abap.operators.concat(new abap.types.Character(16).set('    "foo": "cde"'),abap.operators.concat(new abap.types.Character(3).set('  }'),new abap.types.Character(1).set(']'))))))))));
  ...
  async to_abap_compressed_sort_unique() {
    let lt_foo_bar = abap.types.TableFactory.construct(new abap.types.Structure({"foo": new abap.types.String({qualifiedName: "TY_FOO_BAR-FOO"}), "bar": new abap.types.String({qualifiedName: "TY_FOO_BAR-BAR"})}, "ty_foo_bar", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"SORTED","isUnique":true,"keyFields":["FOO"]},"secondary":[]}, "");
    let ls_foo_bar = new abap.types.Structure({"foo": new abap.types.String({qualifiedName: "TY_FOO_BAR-FOO"}), "bar": new abap.types.String({qualifiedName: "TY_FOO_BAR-BAR"})}, "ty_foo_bar", undefined, {}, {});
    let lo_ajson = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_AJSON", RTTIName: "\\CLASS=Z2UI5_CL_AJSON"});
    let lv_json = new abap.types.String({qualifiedName: "STRING"});
    lv_json.set(abap.operators.concat(new abap.types.Character(1).set('['),abap.operators.concat(new abap.types.Character(3).set('  {'),abap.operators.concat(new abap.types.Character(17).set('    "foo": "abc",'),abap.operators.concat(new abap.types.Character(16).set('    "bar": "123"'),abap.operators.concat(new abap.types.Character(4).set('  },'),abap.operators.concat(new abap.types.Character(3).set('  {'),abap.operators.concat(new abap.types.Character(16).set('    "foo": "cde"'),abap.operators.concat(new abap.types.Character(3).set('  }'),new abap.types.Character(1).set(']'))))))))));
  ...
  async to_abap_compressed_hash() {
    let lt_foo_bar = abap.types.TableFactory.construct(new abap.types.Structure({"foo": new abap.types.String({qualifiedName: "TY_FOO_BAR-FOO"}), "bar": new abap.types.String({qualifiedName: "TY_FOO_BAR-BAR"})}, "ty_foo_bar", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"HASHED","isUnique":true,"keyFields":["FOO"]},"secondary":[]}, "");
    let ls_foo_bar = new abap.types.Structure({"foo": new abap.types.String({qualifiedName: "TY_FOO_BAR-FOO"}), "bar": new abap.types.String({qualifiedName: "TY_FOO_BAR-BAR"})}, "ty_foo_bar", undefined, {}, {});
    let lo_ajson = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_AJSON", RTTIName: "\\CLASS=Z2UI5_CL_AJSON"});
    let lv_json = new abap.types.String({qualifiedName: "STRING"});
    lv_json.set(abap.operators.concat(new abap.types.Character(1).set('['),abap.operators.concat(new abap.types.Character(3).set('  {'),abap.operators.concat(new abap.types.Character(17).set('    "foo": "abc",'),abap.operators.concat(new abap.types.Character(16).set('    "bar": "123"'),abap.operators.concat(new abap.types.Character(4).set('  },'),abap.operators.concat(new abap.types.Character(3).set('  {'),abap.operators.concat(new abap.types.Character(16).set('    "foo": "cde"'),abap.operators.concat(new abap.types.Character(3).set('  }'),new abap.types.Character(1).set(']'))))))))));
...
class ltcl_writer_test {
  ...
  "DELETE": {"visibility": "I", "parameters": {}},
  ...
  "NEW_ARRAY_W_KEEP_ORDER_TOUCH": {"visibility": "I", "parameters": {}},
  ...
  async delete() {
    ...
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(32).set('        |      |object |     ||1')});
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(32).set('/       |a     |object |     ||0')});
    await lo_cut.get().z2ui5_if_ajson$delete({iv_path: new abap.types.Character(4).set('/a/b')});
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({act: lo_cut.get().z2ui5_if_ajson$mt_json_tree, exp: (await lo_nodes_exp.get().sorted())});
    lo_nodes_exp.set(await (new abap.Classes['CLAS-Z2UI5_CL_AJSON-LCL_NODES_HELPER']()).constructor_());
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(32).set('        |      |object |     ||1')});
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(32).set('/       |a     |object |     ||1')});
    ...
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(32).set('        |      |object |     ||1')});
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(32).set('/       |a     |object |     ||0')});
    await lo_cut.get().z2ui5_if_ajson$delete({iv_path: new abap.types.Character(5).set('/a/b/')});
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({act: lo_cut.get().z2ui5_if_ajson$mt_json_tree, exp: (await lo_nodes_exp.get().sorted())});
  }
  async set_ajson() {
    let lo_nodes = new abap.types.ABAPObject({qualifiedName: "LCL_NODES_HELPER", RTTIName: "\\CLASS-POOL=Z2UI5_CL_AJSON\\CLASS=LCL_NODES_HELPER"});
  ...
  async read_only() {
    ...
    try {
      await li_writer.get().z2ui5_if_ajson$delete({iv_path: new abap.types.Character(2).set('/a')});
      await abap.Classes['CL_ABAP_UNIT_ASSERT'].fail();
    } catch (e) {
      if ((abap.Classes['Z2UI5_CX_AJSON_ERROR'] && e instanceof abap.Classes['Z2UI5_CX_AJSON_ERROR'])) {
      } else {
  ...
  async new_array_w_keep_order_touch() {
    let li_cut = new abap.types.ABAPObject({qualifiedName: "Z2UI5_IF_AJSON", RTTIName: "\\INTERFACE=Z2UI5_IF_AJSON"});
    li_cut.set((await (await abap.Classes['Z2UI5_CL_AJSON'].create_empty()).get().z2ui5_if_ajson$set({iv_path: new abap.types.Character(2).set('/b'), iv_val: abap.IntegerFactory.get(1)})));
    await li_cut.get().z2ui5_if_ajson$touch_array({iv_path: new abap.types.Character(2).set('/a')});
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({act: (await li_cut.get().z2ui5_if_ajson$stringify()), exp: new abap.types.Character(14).set('{"a":[],"b":1}')});
    li_cut.set((await (await (await abap.Classes['Z2UI5_CL_AJSON'].create_empty()).get().z2ui5_if_ajson$keep_item_order()).get().z2ui5_if_ajson$set({iv_path: new abap.types.Character(2).set('/b'), iv_val: abap.IntegerFactory.get(1)})));
    await li_cut.get().z2ui5_if_ajson$touch_array({iv_path: new abap.types.Character(2).set('/a')});
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({act: (await li_cut.get().z2ui5_if_ajson$stringify()), exp: new abap.types.Character(14).set('{"b":1,"a":[]}')});
  }
...
class ltcl_integrated {
  ...
  async chaining() {
    ...
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_bound({act: (await li_cut.get().z2ui5_if_ajson$delete({iv_path: new abap.types.Character(2).set('/a')}))});
...
class ltcl_filter_test {
  ...
  async array_test() {
    ...
    await lo_json.get().z2ui5_if_ajson$push({iv_path: new abap.types.Character(1).set('/'), iv_val: new abap.types.Character(1).set('c')});
    await lo_json.get().z2ui5_if_ajson$push({iv_path: new abap.types.Character(1).set('/'), iv_val: new abap.types.Character(1).set('d')});
    await lo_json.get().z2ui5_if_ajson$push({iv_path: new abap.types.Character(1).set('/'), iv_val: new abap.types.Character(1).set('e')});
    await lo_json.get().z2ui5_if_ajson$push({iv_path: new abap.types.Character(1).set('/'), iv_val: new abap.types.Character(1).set('f')});
    await lo_json.get().z2ui5_if_ajson$push({iv_path: new abap.types.Character(1).set('/'), iv_val: new abap.types.Character(1).set('g')});
    await lo_json.get().z2ui5_if_ajson$push({iv_path: new abap.types.Character(1).set('/'), iv_val: new abap.types.Character(1).set('h')});
    await lo_json.get().z2ui5_if_ajson$push({iv_path: new abap.types.Character(1).set('/'), iv_val: new abap.types.Character(1).set('i')});
    await lo_json.get().z2ui5_if_ajson$push({iv_path: new abap.types.Character(1).set('/'), iv_val: new abap.types.Character(1).set('j')});
    lo_json_filtered.set((await abap.Classes['Z2UI5_CL_AJSON'].create_from({ii_source_json: lo_json, ii_filter: this.me})));
    lo_nodes_exp.set(await (new abap.Classes['CLAS-Z2UI5_CL_AJSON-LCL_NODES_HELPER']()).constructor_());
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(33).set('       |      |array  |     | |10')});
    ...
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(32).set('/      |3     |str    |c    |3|0')});
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(32).set('/      |4     |str    |d    |4|0')});
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(32).set('/      |5     |str    |e    |5|0')});
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(32).set('/      |6     |str    |f    |6|0')});
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(32).set('/      |7     |str    |g    |7|0')});
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(32).set('/      |8     |str    |h    |8|0')});
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(32).set('/      |9     |str    |i    |9|0')});
    await lo_nodes_exp.get().add({iv_str: new abap.types.Character(33).set('/      |10    |str    |j    |10|0')});
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({act: lo_json_filtered.get().z2ui5_if_ajson$mt_json_tree, exp: (await lo_nodes_exp.get().sorted())});
  }
  async visit_types() {
    let lo_json = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_AJSON", RTTIName: "\\CLASS=Z2UI5_CL_AJSON"});
...
class ltcl_cloning_test {
  ...
  static IMPLEMENTED_INTERFACES = ["Z2UI5_IF_AJSON_MAPPING","Z2UI5_IF_AJSON_FILTER"];
