...
class ltcl_test_bind {
  ...
  async test_one_way_w_x_error() {
    ...
    let temp13 = new abap.types.DataReference(new abap.types.String({qualifiedName: "STRING"}));
    ...
    try {
      temp13.assign(lo_app_client.get().xx);
      await lo_bind.get().main({val: temp13, type: abap.Classes['Z2UI5_IF_CORE_TYPES'].z2ui5_if_core_types$cs_bind_type.get().one_way});
  ...
  async test_one_way() {
    ...
    let lo_app = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_APP", RTTIName: "\\CLASS=Z2UI5_CL_CORE_APP"});
    let lo_bind = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_BIND_SRV", RTTIName: "\\CLASS=Z2UI5_CL_CORE_BIND_SRV"});
    let temp14 = new abap.types.DataReference(new abap.types.String({qualifiedName: "STRING"}));
    let lv_bind = new abap.types.String({qualifiedName: "STRING"});
    lo_app_client.set(await (new abap.Classes['CLAS-Z2UI5_CL_CORE_BIND_SRV-LTCL_TEST_APP']()).constructor_());
    lo_app.set(await (new abap.Classes['Z2UI5_CL_CORE_APP']()).constructor_());
    lo_app.get().mo_app.set(lo_app_client);
    lo_bind.set(await (new abap.Classes['Z2UI5_CL_CORE_BIND_SRV']()).constructor_({app: lo_app}));
    temp14.assign(lo_app_client.get().mv_value);
    lv_bind.set((await lo_bind.get().main({val: temp14, type: abap.Classes['Z2UI5_IF_CORE_TYPES'].z2ui5_if_core_types$cs_bind_type.get().one_way})));
  ...
  async test_error_diff() {
    ...
    let lo_app = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_APP", RTTIName: "\\CLASS=Z2UI5_CL_CORE_APP"});
    let lo_bind = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_BIND_SRV", RTTIName: "\\CLASS=Z2UI5_CL_CORE_BIND_SRV"});
    let temp15 = new abap.types.DataReference(new abap.types.String({qualifiedName: "STRING"}));
    let temp16 = new abap.types.DataReference(new abap.types.String({qualifiedName: "STRING"}));
    lo_app_client.set(await (new abap.Classes['CLAS-Z2UI5_CL_CORE_BIND_SRV-LTCL_TEST_APP']()).constructor_());
    lo_app.set(await (new abap.Classes['Z2UI5_CL_CORE_APP']()).constructor_());
    lo_app.get().mo_app.set(lo_app_client);
    lo_bind.set(await (new abap.Classes['Z2UI5_CL_CORE_BIND_SRV']()).constructor_({app: lo_app}));
    temp15.assign(lo_app_client.get().mv_value);
    await lo_bind.get().main({val: temp15, type: abap.Classes['Z2UI5_IF_CORE_TYPES'].z2ui5_if_core_types$cs_bind_type.get().one_way});
    try {
      temp16.assign(lo_app_client.get().mv_value);
      await lo_bind.get().main({val: temp16, type: abap.Classes['Z2UI5_IF_CORE_TYPES'].z2ui5_if_core_types$cs_bind_type.get().two_way});
      await abap.Classes['CL_ABAP_UNIT_ASSERT'].abort();
    } catch (e) {
      if ((abap.Classes['CX_ROOT'] && e instanceof abap.Classes['CX_ROOT'])) {
      } else {
  ...
  async test_two_way() {
    ...
    lv_bind.set((await lo_bind.get().main({val: temp17, type: abap.Classes['Z2UI5_IF_CORE_TYPES'].z2ui5_if_core_types$cs_bind_type.get().two_way})));
    temp18.assign(lo_app_client.get().mv_value);
    lv_bind2.set((await lo_bind.get().main({val: temp18, type: abap.Classes['Z2UI5_IF_CORE_TYPES'].z2ui5_if_core_types$cs_bind_type.get().two_way})));
...
class ltcl_test_main_structure {
  ...
  async test_one_way_lev1() {
    ...
    let lo_app = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_APP", RTTIName: "\\CLASS=Z2UI5_CL_CORE_APP"});
    let lo_bind = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_BIND_SRV", RTTIName: "\\CLASS=Z2UI5_CL_CORE_BIND_SRV"});
    let temp19 = new abap.types.DataReference(new abap.types.String({qualifiedName: "LTCL_TEST_MAIN_STRUCTURE=>S_01-INPUT"}));
    let lv_result = new abap.types.String({qualifiedName: "STRING"});
    let temp20 = new abap.types.DataReference(new abap.types.String({qualifiedName: "LTCL_TEST_MAIN_STRUCTURE=>S_01-INPUT"}));
    ...
    lo_bind.set(await (new abap.Classes['Z2UI5_CL_CORE_BIND_SRV']()).constructor_({app: lo_app}));
    temp19.assign(lo_test_app.get().ms_struc.get().input);
    lv_result.set((await lo_bind.get().main({val: temp19, type: abap.Classes['Z2UI5_IF_CORE_TYPES'].z2ui5_if_core_types$cs_bind_type.get().one_way})));
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({act: lv_result, exp: new abap.types.String().set(`{/MS_STRUC/INPUT}`)});
    temp20.assign(lo_test_app.get().ms_struc.get().input);
    abap.statements.clear(temp1);
    temp1.get().path_only.set(abap.builtin.abap_true);
    lv_result.set((await lo_bind.get().main({val: temp20, config: temp1, type: abap.Classes['Z2UI5_IF_CORE_TYPES'].z2ui5_if_core_types$cs_bind_type.get().one_way})));
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({act: lv_result, exp: new abap.types.String().set(`/MS_STRUC/INPUT`)});
  }
  async test_one_way_lev2() {
    ...
    let lo_app = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_APP", RTTIName: "\\CLASS=Z2UI5_CL_CORE_APP"});
    let lo_bind = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_BIND_SRV", RTTIName: "\\CLASS=Z2UI5_CL_CORE_BIND_SRV"});
    let temp21 = new abap.types.DataReference(new abap.types.String({qualifiedName: "LTCL_TEST_MAIN_STRUCTURE=>S_01-S_02-INPUT"}));
    let lv_result = new abap.types.String({qualifiedName: "STRING"});
    lo_test_app.set(await (new abap.Classes['CLAS-Z2UI5_CL_CORE_BIND_SRV-LTCL_TEST_MAIN_STRUCTURE']()).constructor_());
    lo_app.set(await (new abap.Classes['Z2UI5_CL_CORE_APP']()).constructor_());
    lo_app.get().mo_app.set(lo_test_app);
    lo_bind.set(await (new abap.Classes['Z2UI5_CL_CORE_BIND_SRV']()).constructor_({app: lo_app}));
    temp21.assign(lo_test_app.get().ms_struc.get().s_02.get().input);
    lv_result.set((await lo_bind.get().main({val: temp21, type: abap.Classes['Z2UI5_IF_CORE_TYPES'].z2ui5_if_core_types$cs_bind_type.get().one_way})));
  ...
  async test_one_way_lev3() {
    ...
    let lo_app = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_APP", RTTIName: "\\CLASS=Z2UI5_CL_CORE_APP"});
    let lo_bind = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_BIND_SRV", RTTIName: "\\CLASS=Z2UI5_CL_CORE_BIND_SRV"});
    let temp22 = new abap.types.DataReference(new abap.types.String({qualifiedName: "LTCL_TEST_MAIN_STRUCTURE=>S_01-S_02-S_03-INPUT"}));
    let lv_result = new abap.types.String({qualifiedName: "STRING"});
    lo_test_app.set(await (new abap.Classes['CLAS-Z2UI5_CL_CORE_BIND_SRV-LTCL_TEST_MAIN_STRUCTURE']()).constructor_());
    lo_app.set(await (new abap.Classes['Z2UI5_CL_CORE_APP']()).constructor_());
    lo_app.get().mo_app.set(lo_test_app);
    lo_bind.set(await (new abap.Classes['Z2UI5_CL_CORE_BIND_SRV']()).constructor_({app: lo_app}));
    temp22.assign(lo_test_app.get().ms_struc.get().s_02.get().s_03.get().input);
    lv_result.set((await lo_bind.get().main({val: temp22, type: abap.Classes['Z2UI5_IF_CORE_TYPES'].z2ui5_if_core_types$cs_bind_type.get().one_way})));
  ...
  async test_one_way_lev4_long_name() {
    ...
    let lo_app = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_APP", RTTIName: "\\CLASS=Z2UI5_CL_CORE_APP"});
    let lo_bind = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_BIND_SRV", RTTIName: "\\CLASS=Z2UI5_CL_CORE_BIND_SRV"});
    let temp23 = new abap.types.DataReference(new abap.types.String({qualifiedName: "LTCL_TEST_MAIN_STRUCTURE=>S_01-S_02-S_03-S_04-INPUT"}));
    let lv_result = new abap.types.String({qualifiedName: "STRING"});
    lo_test_app.set(await (new abap.Classes['CLAS-Z2UI5_CL_CORE_BIND_SRV-LTCL_TEST_MAIN_STRUCTURE']()).constructor_());
    lo_app.set(await (new abap.Classes['Z2UI5_CL_CORE_APP']()).constructor_());
    lo_app.get().mo_app.set(lo_test_app);
    lo_bind.set(await (new abap.Classes['Z2UI5_CL_CORE_BIND_SRV']()).constructor_({app: lo_app}));
    temp23.assign(lo_test_app.get().ms_struc.get().s_02.get().s_03.get().s_04.get().input);
    lv_result.set((await lo_bind.get().main({val: temp23, type: abap.Classes['Z2UI5_IF_CORE_TYPES'].z2ui5_if_core_types$cs_bind_type.get().one_way})));
...
class ltcl_test_main_object {
  ...
  async test_one_way_value() {
    ...
    lo_app.get().mo_app.set(lo_test_app);
    lo_bind.set(await (new abap.Classes['Z2UI5_CL_CORE_BIND_SRV']()).constructor_({app: lo_app}));
    temp24.assign(lo_test_app.get().mo_obj.get().mv_value);
    lv_result.set((await lo_bind.get().main({val: temp24, type: abap.Classes['Z2UI5_IF_CORE_TYPES'].z2ui5_if_core_types$cs_bind_type.get().one_way})));
  ...
  async test_one_way_struc() {
    ...
    let lo_app = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_APP", RTTIName: "\\CLASS=Z2UI5_CL_CORE_APP"});
    let lo_bind = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_CORE_BIND_SRV", RTTIName: "\\CLASS=Z2UI5_CL_CORE_BIND_SRV"});
    let temp25 = new abap.types.DataReference(new abap.types.String({qualifiedName: "LTCL_TEST_MAIN_OBJECT=>S_01-INPUT"}));
    let lv_result = new abap.types.String({qualifiedName: "STRING"});
    lo_test_app.set(await (new abap.Classes['CLAS-Z2UI5_CL_CORE_BIND_SRV-LTCL_TEST_MAIN_OBJECT']()).constructor_());
    lo_test_app.get().mo_obj.set(await (new abap.Classes['CLAS-Z2UI5_CL_CORE_BIND_SRV-LTCL_TEST_MAIN_OBJECT']()).constructor_());
    lo_app.set(await (new abap.Classes['Z2UI5_CL_CORE_APP']()).constructor_());
    lo_app.get().mo_app.set(lo_test_app);
    lo_bind.set(await (new abap.Classes['Z2UI5_CL_CORE_BIND_SRV']()).constructor_({app: lo_app}));
    temp25.assign(lo_test_app.get().mo_obj.get().ms_struc.get().input);
