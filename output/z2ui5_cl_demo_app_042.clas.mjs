await import("./z2ui5_cl_demo_app_042.clas.locals.mjs");
const {cx_root} = await import("./cx_root.clas.mjs");
// z2ui5_cl_demo_app_042.clas.abap
class z2ui5_cl_demo_app_042 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_042';
  ...
  async z2ui5_if_app$main(INPUT) {
    ...
    let unique239 = ((await client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique239, new abap.types.Character(16).set('BUTTON_ROUNDTRIP'))) {
      lv_dummy.set(new abap.types.Character(68).set('user pressed a button, your custom implementation can be called here'));
    } else if (abap.compare.eq(unique239, new abap.types.Character(14).set('BUTTON_MSG_BOX'))) {
    ...
    } else if (abap.compare.eq(unique239, new abap.types.Character(4).set('BACK'))) {
    ...
    await (await (await (await header_title.get().snapped_heading()).get().flex_box({alignitems: new abap.types.String().set(`Center`)})).get().avatar({src: (await abap.Classes['CLAS-Z2UI5_CL_DEMO_APP_042-LCL_HELP'].get_avatar()), class: new abap.types.Character(18).set('sapUiTinyMarginEnd')})).get().title({text: new abap.types.Character(11).set('Oblomov Dev'), wrapping: abap.builtin.abap_true});
    ...
    await (await (await (await (await (await (await (await (await (await (await (await (await (await (await (await (await (await (await (await header_content.get().flex_box({wrap: new abap.types.Character(4).set('Wrap')})).get().avatar({src: (await abap.Classes['CLAS-Z2UI5_CL_DEMO_APP_042-LCL_HELP'].get_avatar()), class: new abap.types.Character(19).set('sapUiSmallMarginEnd'), displaysize: new abap.types.Character(6).set('layout')})).get().vertical_layout({class: new abap.types.Character(24).set('sapUiSmallMarginBeginEnd')})).get().link({text: new abap.types.Character(15).set('+33 6 4512 5158')})).get().link({text: new abap.types.Character(15).set('email@email.com')})).get().get_parent()).get().horizontal_layout({class: new abap.types.Character(24).set('sapUiSmallMarginBeginEnd')})).get().label({text: new abap.types.Character(30).set('Hello! I an abap2UI5 developer')})).get().label({text: new abap.types.Character(13).set('San Jose, USA')})).get().get_parent()).get().vertical_layout({class: new abap.types.Character(24).set('sapUiSmallMarginBeginEnd')})).get().label({text: new abap.types.Character(30).set('Hello! I an abap2UI5 developer')})).get().vbox()).get().label({text: new abap.types.Character(13).set('Achived goals')})).get().progress_indicator({percentvalue: new abap.types.Character(3).set('30%'), displayvalue: new abap.types.Character(3).set('30%')})).get().get_parent()).get().get_parent()).get().vertical_layout({class: new abap.types.Character(24).set('sapUiSmallMarginBeginEnd')})).get().label({text: new abap.types.Character(13).set('San Jose, USA')})).get().get_parent();
...
abap.Classes['Z2UI5_CL_DEMO_APP_042'] = z2ui5_cl_demo_app_042;
z2ui5_cl_demo_app_042.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_042.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_demo_app_042.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_042.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_demo_app_042.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_042.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_demo_app_042.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_042.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_demo_app_042};
//# sourceMappingURL=z2ui5_cl_demo_app_042.clas.mjs.map