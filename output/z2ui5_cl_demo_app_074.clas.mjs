...
// z2ui5_cl_demo_app_074.clas.abap
class z2ui5_cl_demo_app_074 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_074';
  ...
  async ui5_on_event() {
    ...
    try {
      let unique296 = ((await this.client.get().z2ui5_if_client$get())).get().event;
      if (abap.compare.eq(unique296, new abap.types.Character(5).set('START')) || abap.compare.eq(unique296, new abap.types.Character(6).set('CHANGE'))) {
        await this.ui5_view_main_display();
      } else if (abap.compare.eq(unique296, new abap.types.Character(6).set('UPLOAD'))) {
      ...
      } else if (abap.compare.eq(unique296, new abap.types.Character(4).set('BACK'))) {
  ...
  async ui5_view_main_display() {
    ...
    if (abap.compare.initial(this.mr_table) === false) {
      ...
      for await (const unique297 of abap.statements.loop(lr_fields)) {
        lr_col.assign(unique297);
      ...
      for await (const unique298 of abap.statements.loop(lr_fields)) {
        lr_col.assign(unique298);
...
abap.Classes['Z2UI5_CL_DEMO_APP_074'] = z2ui5_cl_demo_app_074;
z2ui5_cl_demo_app_074.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_074.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_demo_app_074.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_074.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_demo_app_074.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_074.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_demo_app_074.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_074.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_demo_app_074};
//# sourceMappingURL=z2ui5_cl_demo_app_074.clas.mjs.map