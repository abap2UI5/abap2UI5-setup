...
// z2ui5_cl_demo_app_246.clas.abap
class z2ui5_cl_demo_app_246 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_246';
  ...
  async display_view(INPUT) {
    ...
    page.set((await (await (await abap.Classes['Z2UI5_CL_XML_VIEW'].factory()).get().shell()).get().page({title: new abap.types.Character(47).set('abap2UI5 - Sample: Input - Suggestions wrapping'), navbuttonpress: (await client.get().z2ui5_if_client$_event({val: new abap.types.Character(4).set('BACK')})), shownavbutton: temp1})));
    ...
    await (await page.get().header_content()).get().link({text: new abap.types.Character(12).set('UI5 Demo Kit'), target: new abap.types.Character(6).set('_blank'), href: new abap.types.Character(91).set('https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.Input/sample/sap.m.sample.InputWrapping')});
    ...
    await layout.get().label({text: new abap.types.String().set(`Product`), labelfor: new abap.types.String().set(`wrappingInput`)});
    await (await (await (await (await (await (await layout.get().input({id: new abap.types.String().set(`wrappingInput`), placeholder: new abap.types.String().set(`Enter product`), showsuggestion: abap.builtin.abap_true, width: new abap.types.String().set(`50%`)})).get().get()).get().suggestion_items()).get().item({key: new abap.types.String().set(`1`), text: abap.operators.concat(new abap.types.String().set(`Wireless DSL/ Repeater and Print Server Lorem ipsum dolar st amet, consetetur sadipscing elitr, `),abap.operators.concat(new abap.types.String().set(`sed diam nonumy eirmod tempor incidunt ut labore et dolore magna aliquyam erat, diam nonumy eirmod `),new abap.types.String().set(`tempor individunt ut labore et dolore magna aliquyam erat, sed justo et ea rebum.`)))})).get().item({key: new abap.types.String().set(`2`), text: abap.operators.concat(new abap.types.String().set(`7" Widescreen Portable DVD Player w MP3, consetetur sadipscing, sed diam nonumy eirmod tempor invidunt `),abap.operators.concat(new abap.types.String().set(`ut labore et dolore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et `),new abap.types.String().set(`ea rebum. Stet clita kasd gubergen, no sea takimata. Tortor pretium viverra suspendisse potenti nullam.`)))})).get().get_parent()).get().item({key: new abap.types.String().set(`3`), text: new abap.types.String().set(`Portable DVD Player with 9" LCD Monitor`)});
  ...
  async on_event(INPUT) {
    ...
    if (client?.getQualifiedName === undefined || client.getQualifiedName() !== "Z2UI5_IF_CLIENT") { client = undefined; }
    if (client === undefined) { client = new abap.types.ABAPObject({qualifiedName: "Z2UI5_IF_CLIENT", RTTIName: "\\INTERFACE=Z2UI5_IF_CLIENT"}).set(INPUT.client); }
    let unique541 = ((await client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique541, new abap.types.Character(4).set('BACK'))) {
      await client.get().z2ui5_if_client$nav_app_leave();
    } else if (abap.compare.eq(unique541, new abap.types.Character(7).set('POPOVER'))) {
...
abap.Classes['Z2UI5_CL_DEMO_APP_246'] = z2ui5_cl_demo_app_246;
z2ui5_cl_demo_app_246.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_246.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_demo_app_246.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_246.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_demo_app_246.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_246.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_demo_app_246.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_246.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_demo_app_246};
//# sourceMappingURL=z2ui5_cl_demo_app_246.clas.mjs.map