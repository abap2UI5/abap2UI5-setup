...
// z2ui5_cl_popup_file_download.clas.abap
class z2ui5_cl_popup_file_download {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_POPUP_FILE_DOWNLOAD';
  ...
  "FACTORY": {"visibility": "U", "parameters": {"R_RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POPUP_FILE_DOWNLOAD", RTTIName: "\\CLASS=Z2UI5_CL_POPUP_FILE_DOWNLOAD"});}, "is_optional": " "}, "I_TEXT": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "I_TITLE": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "I_BUTTON_TEXT_CONFIRM": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "I_BUTTON_TEXT_CANCEL": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "I_FILE": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "I_TYPE": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}}},
  ...
  async factory(INPUT) {
    return z2ui5_cl_popup_file_download.factory(INPUT);
  }
  static async factory(INPUT) {
    let r_result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POPUP_FILE_DOWNLOAD", RTTIName: "\\CLASS=Z2UI5_CL_POPUP_FILE_DOWNLOAD"});
    ...
    r_result.set(await (new abap.Classes['Z2UI5_CL_POPUP_FILE_DOWNLOAD']()).constructor_());
  ...
  async view_display() {
    ...
    await (await (await (await (await (await (await (await (await (await (await (await (await (await popup.get().vbox({class_: new abap.types.Character(17).set('sapUiMediumMargin')})).get().label({text: new abap.types.String().set(`Name`)})).get().input({value: this.mv_name, enabled: abap.builtin.abap_false})).get().label({text: new abap.types.String().set(`Type`)})).get().input({value: this.mv_type, enabled: abap.builtin.abap_false})).get().label({text: new abap.types.String().set(`Size`)})).get().input({value: this.mv_size, enabled: abap.builtin.abap_false})).get().get_parent()).get().get_parent()).get().footer()).get().overflow_toolbar()).get().toolbar_spacer()).get().button({text: this.button_text_cancel, press: (await this.client.get().z2ui5_if_client$_event({val: new abap.types.Character(13).set('BUTTON_CANCEL')}))})).get().button({text: new abap.types.String().set(`Download`), press: (await this.client.get().z2ui5_if_client$_event({val: new abap.types.Character(14).set('BUTTON_CONFIRM')})), type: new abap.types.Character(10).set('Emphasized')});
  ...
  async z2ui5_if_app$main(INPUT) {
    ...
    let unique158 = ((await client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique158, new abap.types.String().set(`CALLBACK_DOWNLOAD`))) {
    ...
    } else if (abap.compare.eq(unique158, new abap.types.String().set(`BUTTON_CONFIRM`))) {
      this.mv_check_download.set(abap.builtin.abap_true);
      await this.view_display();
    } else if (abap.compare.eq(unique158, new abap.types.String().set(`BUTTON_CANCEL`))) {
      await client.get().z2ui5_if_client$popup_destroy();
      await client.get().z2ui5_if_client$nav_app_leave({app: (await client.get().z2ui5_if_client$get_app({id: ((await client.get().z2ui5_if_client$get())).get().s_draft.get().id_prev_app_stack}))});
    }
  }
}
abap.Classes['Z2UI5_CL_POPUP_FILE_DOWNLOAD'] = z2ui5_cl_popup_file_download;
z2ui5_cl_popup_file_download.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_popup_file_download.z2ui5_if_app$version.set('1.120.0');
z2ui5_cl_popup_file_download.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_popup_file_download.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_popup_file_download.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_popup_file_download.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_popup_file_download};
//# sourceMappingURL=z2ui5_cl_popup_file_download.clas.mjs.map