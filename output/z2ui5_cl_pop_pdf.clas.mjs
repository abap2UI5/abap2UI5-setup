...
// z2ui5_cl_pop_pdf.clas.abap
class z2ui5_cl_pop_pdf {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_POP_PDF';
  static IMPLEMENTED_INTERFACES = ["Z2UI5_IF_APP","IF_SERIALIZABLE_OBJECT"];
  static ATTRIBUTES = {"MS_RESULT": {"type": () => {return new abap.types.Structure({"text": new abap.types.String({qualifiedName: "Z2UI5_CL_POP_PDF=>TY_S_RESULT-TEXT"}), "check_confirmed": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"})}, "z2ui5_cl_pop_pdf=>ty_s_result", undefined, {}, {});}, "visibility": "U", "is_constant": " ", "is_class": " "},
  ...
  "FACTORY": {"visibility": "U", "parameters": {"R_RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POP_PDF", RTTIName: "\\CLASS=Z2UI5_CL_POP_PDF"});}, "is_optional": " "}, "I_TITLE": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "I_BUTTON_TEXT_CONFIRM": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "I_BUTTON_TEXT_CANCEL": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "I_PDF": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}}},
  "RESULT": {"visibility": "U", "parameters": {"RESULT": {"type": () => {return new abap.types.Structure({"text": new abap.types.String({qualifiedName: "Z2UI5_CL_POP_PDF=>TY_S_RESULT-TEXT"}), "check_confirmed": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"})}, "z2ui5_cl_pop_pdf=>ty_s_result", undefined, {}, {});}, "is_optional": " "}}}};
  constructor() {
    this.me = new abap.types.ABAPObject();
    this.me.set(this);
    this.ms_result = new abap.types.Structure({"text": new abap.types.String({qualifiedName: "Z2UI5_CL_POP_PDF=>TY_S_RESULT-TEXT"}), "check_confirmed": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"})}, "z2ui5_cl_pop_pdf=>ty_s_result", undefined, {}, {});
  ...
  async factory(INPUT) {
    return z2ui5_cl_pop_pdf.factory(INPUT);
  }
  static async factory(INPUT) {
    let r_result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POP_PDF", RTTIName: "\\CLASS=Z2UI5_CL_POP_PDF"});
    ...
    r_result.set(await (new abap.Classes['Z2UI5_CL_POP_PDF']()).constructor_());
  ...
  async result() {
    let result = new abap.types.Structure({"text": new abap.types.String({qualifiedName: "Z2UI5_CL_POP_PDF=>TY_S_RESULT-TEXT"}), "check_confirmed": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"})}, "z2ui5_cl_pop_pdf=>ty_s_result", undefined, {}, {});
  ...
  async view_display() {
    ...
    abap.statements.insertInternal({data: temp2, table: temp1});
    popup.set((await (await (await (await (await (await (await (await (await (await (await (await abap.Classes['Z2UI5_CL_XML_VIEW'].factory_popup()).get().dialog({title: this.title, icon: this.icon, stretch: abap.builtin.abap_true, afterclose: (await this.client.get().z2ui5_if_client$_event({val: new abap.types.Character(13).set('BUTTON_CANCEL')}))})).get().content()).get().vbox({class: new abap.types.Character(17).set('sapUiMediumMargin')})).get().label({text: this.question_text})).get()._generic({ns: new abap.types.String().set(`html`), name: new abap.types.String().set(`iframe`), t_prop: temp1})).get().get_parent()).get().get_parent()).get().get_parent()).get().buttons()).get().button({text: this.button_text_cancel, press: (await this.client.get().z2ui5_if_client$_event({val: new abap.types.Character(13).set('BUTTON_CANCEL')}))})).get().button({text: this.button_text_confirm, press: (await this.client.get().z2ui5_if_client$_event({val: new abap.types.Character(14).set('BUTTON_CONFIRM')})), type: new abap.types.Character(10).set('Emphasized')})));
  ...
  async z2ui5_if_app$main(INPUT) {
    ...
    let unique160 = ((await client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique160, new abap.types.String().set(`BUTTON_CONFIRM`))) {
    ...
    } else if (abap.compare.eq(unique160, new abap.types.String().set(`BUTTON_CANCEL`))) {
...
abap.Classes['Z2UI5_CL_POP_PDF'] = z2ui5_cl_pop_pdf;
z2ui5_cl_pop_pdf.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_pdf.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_pop_pdf.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_pdf.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_pop_pdf.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_pdf.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_pop_pdf.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_pdf.z2ui5_if_app$license.set('MIT');
z2ui5_cl_pop_pdf.ty_s_result = new abap.types.Structure({"text": new abap.types.String({qualifiedName: "Z2UI5_CL_POP_PDF=>TY_S_RESULT-TEXT"}), "check_confirmed": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"})}, "z2ui5_cl_pop_pdf=>ty_s_result", undefined, {}, {});
export {z2ui5_cl_pop_pdf};
//# sourceMappingURL=z2ui5_cl_pop_pdf.clas.mjs.map