...
// z2ui5_cl_demo_app_259.clas.abap
class z2ui5_cl_demo_app_259 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_259';
  ...
  async display_view(INPUT) {
    ...
    page_01.set((await (await (await abap.Classes['Z2UI5_CL_XML_VIEW'].factory()).get().shell()).get().page({title: new abap.types.String().set(`abap2UI5 - Sample: Button`), navbuttonpress: (await client.get().z2ui5_if_client$_event({val: new abap.types.Character(4).set('BACK')})), shownavbutton: temp13})));
    ...
    await (await page_01.get().header_content()).get().link({text: new abap.types.Character(12).set('UI5 Demo Kit'), target: new abap.types.Character(6).set('_blank'), href: new abap.types.Character(85).set('https://sapui5.hana.ondemand.com/sdk/#/entity/sap.m.Button/sample/sap.m.sample.Button')});
  ...
  async on_event(INPUT) {
    ...
    if (client?.getQualifiedName === undefined || client.getQualifiedName() !== "Z2UI5_IF_CLIENT") { client = undefined; }
    if (client === undefined) { client = new abap.types.ABAPObject({qualifiedName: "Z2UI5_IF_CLIENT", RTTIName: "\\INTERFACE=Z2UI5_IF_CLIENT"}).set(INPUT.client); }
    let unique555 = ((await client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique555, new abap.types.Character(4).set('BACK'))) {
      await client.get().z2ui5_if_client$nav_app_leave();
    } else if (abap.compare.eq(unique555, new abap.types.Character(15).set('CLICK_HINT_ICON'))) {
      await this.z2ui5_display_popover({id: new abap.types.String().set(`button_hint_id`)});
    } else if (abap.compare.eq(unique555, new abap.types.Character(7).set('onPress'))) {
...
abap.Classes['Z2UI5_CL_DEMO_APP_259'] = z2ui5_cl_demo_app_259;
z2ui5_cl_demo_app_259.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_259.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_demo_app_259.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_259.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_demo_app_259.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_259.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_demo_app_259.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_259.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_demo_app_259};
//# sourceMappingURL=z2ui5_cl_demo_app_259.clas.mjs.map