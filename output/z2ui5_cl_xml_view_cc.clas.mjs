...
class z2ui5_cl_xml_view_cc {
  ...
  static METHODS = {"MULTIINPUT_EXT": {"visibility": "U", "parameters": {"RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});}, "is_optional": " "}, "MULTIINPUTID": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "MULTIINPUTNAME": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "CHANGE": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "ADDEDTOKENS": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "REMOVEDTOKENS": {"type": () => {return new abap.types.Character();}, "is_optional": " "}}},
  ...
  "INFO_FRONTEND": {"visibility": "U", "parameters": {"RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});}, "is_optional": " "}, "FINISHED": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "UI5_VERSION": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "DEVICE_HEIGHT": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "DEVICE_WIDTH": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "DEVICE_PHONE": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "DEVICE_DESKTOP": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "DEVICE_TABLET": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "DEVICE_COMBI": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "UI5_GAV": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "UI5_THEME": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "DEVICE_OS": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "DEVICE_SYSTEMTYPE": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "DEVICE_BROWSER": {"type": () => {return new abap.types.Character();}, "is_optional": " "}}},
  "SPREADSHEET_EXPORT": {"visibility": "U", "parameters": {"RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});}, "is_optional": " "}, "TABLEID": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "TYPE": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "TEXT": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "ICON": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "TOOLTIP": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "COLUMNCONFIG": {"type": () => {return new abap.types.Character();}, "is_optional": " "}}},
  "FILE_UPLOADER": {"visibility": "U", "parameters": {"RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});}, "is_optional": " "}, "VALUE": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "PATH": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "PLACEHOLDER": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "UPLOAD": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "ICONONLY": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "BUTTONONLY": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "BUTTONTEXT": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "UPLOADBUTTONTEXT": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "CHECKDIRECTUPLOAD": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "FILETYPE": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "ICON": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "ENABLED": {"type": () => {return new abap.types.Character();}, "is_optional": " "}}},
  ...
  "DIRTY": {"visibility": "U", "parameters": {"RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});}, "is_optional": " "}, "ISDIRTY": {"type": () => {return new abap.types.Character();}, "is_optional": " "}}},
  "LP_TITLE": {"visibility": "U", "parameters": {"RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});}, "is_optional": " "}, "TITLE": {"type": () => {return new abap.types.Character();}, "is_optional": " "}}},
  ...
  "WEBSOCKET": {"visibility": "U", "parameters": {"RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});}, "is_optional": " "}, "VALUE": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "RECEIVED": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "PATH": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "CHECKREPEAT": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "CHECKACTIVE": {"type": () => {return new abap.types.Character();}, "is_optional": " "}}},
  "BINDING_UPDATE": {"visibility": "U", "parameters": {"RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});}, "is_optional": " "}, "CHANGED": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "PATH": {"type": () => {return new abap.types.Character();}, "is_optional": " "}}},
  ...
  "APPROVE_POPOVER": {"visibility": "U", "parameters": {"RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});}, "is_optional": " "}, "PLACEMENT": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "CLASS": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "TEXT": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "BTN_TXT": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "BTN_TYPE": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "BTN_ICON": {"type": () => {return new abap.types.Character();}, "is_optional": " "}, "BTN_EVENT": {"type": () => {return new abap.types.Character();}, "is_optional": " "}}},
  ...
  async approve_popover(INPUT) {
    ...
    let btn_txt = INPUT?.btn_txt || new abap.types.Character();
    let btn_type = INPUT?.btn_type || new abap.types.Character();
    let btn_icon = INPUT?.btn_icon || new abap.types.Character();
    let btn_event = INPUT?.btn_event || new abap.types.Character();
    result.set(this.mo_view);
    await (await (await (await (await this.mo_view.get().popover({showheader: abap.builtin.abap_false, placement: placement, class: $class})).get().hbox({justifycontent: new abap.types.String().set(`Center`)})).get().vbox({justifycontent: new abap.types.String().set(`Center`), alignitems: new abap.types.String().set(`Center`)})).get().text({text: text})).get().button({type: btn_type, text: btn_txt, icon: btn_icon, press: btn_event});
    return result;
  }
  async bwip_js(INPUT) {
    let result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});
  ...
  async demo_output(INPUT) {
    ...
    let lv_class = new abap.types.Character(20, {});
    await this.mo_view.get()._generic({ns: new abap.types.String().set(`html`), name: new abap.types.String().set(`style`)});
    lv_class.set(new abap.types.Character(20).set('Z2UI5_CL_CC_DEMO_OUT'));
    ...
    if (abap.Classes[lv_class.get().trimEnd()].get_style === undefined && abap.Classes['CX_SY_DYN_CALL_ILLEGAL_METHOD'.trimEnd()] === undefined) { throw "CX_SY_DYN_CALL_ILLEGAL_METHOD not found"; }
    if (abap.Classes[lv_class.get().trimEnd()].get_style === undefined) { throw new abap.Classes['CX_SY_DYN_CALL_ILLEGAL_METHOD'.trimEnd()](); }
    lv_style.set(await abap.Classes[lv_class.get().trimEnd()].get_style());
  ...
  async info_frontend(INPUT) {
    let result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});
    let finished = INPUT?.finished || new abap.types.Character();
    let ui5_version = INPUT?.ui5_version || new abap.types.Character();
    let device_height = INPUT?.device_height || new abap.types.Character();
    let device_width = INPUT?.device_width || new abap.types.Character();
    let device_phone = INPUT?.device_phone || new abap.types.Character();
    let device_desktop = INPUT?.device_desktop || new abap.types.Character();
    let device_tablet = INPUT?.device_tablet || new abap.types.Character();
    let device_combi = INPUT?.device_combi || new abap.types.Character();
    let ui5_gav = INPUT?.ui5_gav || new abap.types.Character();
    let ui5_theme = INPUT?.ui5_theme || new abap.types.Character();
    let device_os = INPUT?.device_os || new abap.types.Character();
    let device_systemtype = INPUT?.device_systemtype || new abap.types.Character();
    let device_browser = INPUT?.device_browser || new abap.types.Character();
    ...
    abap.statements.insertInternal({data: temp18, table: temp17});
    temp18.get().n.set(new abap.types.String().set(`device_phone`));
    temp18.get().v.set(device_phone);
    abap.statements.insertInternal({data: temp18, table: temp17});
    temp18.get().n.set(new abap.types.String().set(`device_desktop`));
    temp18.get().v.set(device_desktop);
    abap.statements.insertInternal({data: temp18, table: temp17});
    temp18.get().n.set(new abap.types.String().set(`device_tablet`));
    temp18.get().v.set(device_tablet);
    abap.statements.insertInternal({data: temp18, table: temp17});
    temp18.get().n.set(new abap.types.String().set(`device_combi`));
    temp18.get().v.set(device_combi);
    abap.statements.insertInternal({data: temp18, table: temp17});
    temp18.get().n.set(new abap.types.String().set(`device_height`));
    temp18.get().v.set(device_height);
    abap.statements.insertInternal({data: temp18, table: temp17});
    temp18.get().n.set(new abap.types.String().set(`device_width`));
    temp18.get().v.set(device_width);
    abap.statements.insertInternal({data: temp18, table: temp17});
  ...
  async multiinput_ext(INPUT) {
    ...
    let multiinputname = INPUT?.multiinputname || new abap.types.Character();
    ...
    temp24.get().n.set(new abap.types.String().set(`MultiInputName`));
    temp24.get().v.set(multiinputname);
    abap.statements.insertInternal({data: temp24, table: temp23});
  ...
  async spreadsheet_export(INPUT) {
    ...
    let columnconfig = INPUT?.columnconfig || new abap.types.Character();
    ...
    abap.statements.insertInternal({data: temp28, table: temp27});
    temp28.get().n.set(new abap.types.String().set(`tooltip`));
    temp28.get().v.set(tooltip);
    abap.statements.insertInternal({data: temp28, table: temp27});
    temp28.get().n.set(new abap.types.String().set(`columnconfig`));
    temp28.get().v.set(columnconfig);
    abap.statements.insertInternal({data: temp28, table: temp27});
  ...
  async binding_update(INPUT) {
    let result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});
    let changed = INPUT?.changed || new abap.types.Character();
    let path = INPUT?.path || new abap.types.Character();
    ...
    temp32.get().n.set(new abap.types.String().set(`path`));
    temp32.get().v.set(path);
    abap.statements.insertInternal({data: temp32, table: temp31});
    temp32.get().n.set(new abap.types.String().set(`changed`));
    temp32.get().v.set(changed);
    abap.statements.insertInternal({data: temp32, table: temp31});
    await this.mo_view.get()._generic({name: new abap.types.String().set(`BindingUpdate`), ns: new abap.types.String().set(`z2ui5`), t_prop: temp31});
    return result;
  }
  async websocket(INPUT) {
    let result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});
    let value = INPUT?.value || new abap.types.Character();
    let received = INPUT?.received || new abap.types.Character();
    let path = INPUT?.path || new abap.types.Character();
    let checkrepeat = INPUT?.checkrepeat || new abap.types.Character();
    let checkactive = INPUT?.checkactive || new abap.types.Character();
    ...
    temp34.get().n.set(new abap.types.String().set(`value`));
    temp34.get().v.set(value);
    abap.statements.insertInternal({data: temp34, table: temp33});
    temp34.get().n.set(new abap.types.String().set(`path`));
    temp34.get().v.set(path);
    abap.statements.insertInternal({data: temp34, table: temp33});
    temp34.get().n.set(new abap.types.String().set(`received`));
    temp34.get().v.set(received);
    abap.statements.insertInternal({data: temp34, table: temp33});
    temp34.get().n.set(new abap.types.String().set(`checkActive`));
    temp34.get().v.set((await abap.Classes['Z2UI5_CL_UTIL'].boolean_abap_2_json({val: checkactive})));
    abap.statements.insertInternal({data: temp34, table: temp33});
    temp34.get().n.set(new abap.types.String().set(`checkRepeat`));
    temp34.get().v.set((await abap.Classes['Z2UI5_CL_UTIL'].boolean_abap_2_json({val: checkrepeat})));
    abap.statements.insertInternal({data: temp34, table: temp33});
    await this.mo_view.get()._generic({name: new abap.types.String().set(`Websocket`), ns: new abap.types.String().set(`z2ui5`), t_prop: temp33});
    return result;
  }
  async lp_title(INPUT) {
    let result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});
    ...
    temp36.get().n.set(new abap.types.String().set(`title`));
    temp36.get().v.set(title);
    abap.statements.insertInternal({data: temp36, table: temp35});
    await this.mo_view.get()._generic({name: new abap.types.String().set(`LPTitle`), ns: new abap.types.String().set(`z2ui5`), t_prop: temp35});
    return result;
  }
  async title(INPUT) {
    let result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});
    ...
    await this.mo_view.get()._generic({name: new abap.types.String().set(`Title`), ns: new abap.types.String().set(`z2ui5`), t_prop: temp37});
    return result;
  }
  async dirty(INPUT) {
    let result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_XML_VIEW", RTTIName: "\\CLASS=Z2UI5_CL_XML_VIEW"});
    let isdirty = INPUT?.isdirty || new abap.types.Character();
    ...
    temp40.get().n.set(new abap.types.String().set(`isDirty`));
    temp40.get().v.set((await abap.Classes['Z2UI5_CL_UTIL'].boolean_abap_2_json({val: isdirty})));
    abap.statements.insertInternal({data: temp40, table: temp39});
    await this.mo_view.get()._generic({name: new abap.types.String().set(`Dirty`), ns: new abap.types.String().set(`z2ui5`), t_prop: temp39});
    return result;
  }
  async uitableext(INPUT) {
    ...
    temp42.get().n.set(new abap.types.String().set(`tableId`));
    temp42.get().v.set(tableid);
    abap.statements.insertInternal({data: temp42, table: temp41});
    result.set((await this.mo_view.get()._generic({name: new abap.types.String().set(`UITableExt`), ns: new abap.types.String().set(`z2ui5`), t_prop: temp41})));
    return result;
  }
}
