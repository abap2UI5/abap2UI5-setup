...
// z2ui5_cl_pop_js_loader.clas.abap
class z2ui5_cl_pop_js_loader {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_POP_JS_LOADER';
  ...
  "FACTORY": {"visibility": "U", "parameters": {"R_RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POP_JS_LOADER", RTTIName: "\\CLASS=Z2UI5_CL_POP_JS_LOADER"});}, "is_optional": " "}, "I_JS": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "I_RESULT": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}}},
  "FACTORY_CHECK_OPEN_UI5": {"visibility": "U", "parameters": {"R_RESULT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POP_JS_LOADER", RTTIName: "\\CLASS=Z2UI5_CL_POP_JS_LOADER"});}, "is_optional": " "}}},
  ...
  async factory(INPUT) {
    return z2ui5_cl_pop_js_loader.factory(INPUT);
  }
  static async factory(INPUT) {
    let r_result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POP_JS_LOADER", RTTIName: "\\CLASS=Z2UI5_CL_POP_JS_LOADER"});
    let i_js = INPUT?.i_js;
    ...
    r_result.set(await (new abap.Classes['Z2UI5_CL_POP_JS_LOADER']()).constructor_());
    r_result.get().js.set(i_js);
    r_result.get().user_command.set(i_result);
    return r_result;
  }
  async factory_check_open_ui5() {
    return z2ui5_cl_pop_js_loader.factory_check_open_ui5();
  }
  ...
  async z2ui5_if_app$main(INPUT) {
    ...
    if (abap.compare.eq(unique158, new abap.types.String().set(`INFO_FINISHED`))) {
    ...
    } else if (abap.compare.eq(unique158, new abap.types.String().set(`TIMER_FINISHED`))) {
      await client.get().z2ui5_if_client$popup_destroy();
      await client.get().z2ui5_if_client$nav_app_leave({app: (await client.get().z2ui5_if_client$get_app({id: ((await client.get().z2ui5_if_client$get())).get().s_draft.get().id_prev_app_stack}))});
    } else {
    }
...
abap.Classes['Z2UI5_CL_POP_JS_LOADER'] = z2ui5_cl_pop_js_loader;
z2ui5_cl_pop_js_loader.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_js_loader.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_pop_js_loader.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_js_loader.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_pop_js_loader.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_js_loader.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_pop_js_loader.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_js_loader.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_pop_js_loader};
//# sourceMappingURL=z2ui5_cl_pop_js_loader.clas.mjs.map