...
class cl_abap_timefm {
  ...
  static async conv_time_ext_to_int(INPUT) {
    ...
    if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
      const unique630 = await (new abap.Classes['CX_ABAP_TIMEFM_INVALID']()).constructor_();
      unique630.EXTRA_CX = {"INTERNAL_FILENAME": "cl_abap_timefm.clas.abap","INTERNAL_LINE": 38};
      throw unique630;
    }
