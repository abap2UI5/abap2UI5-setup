...
// z2ui5_cl_demo_app_165.clas.abap
class z2ui5_cl_demo_app_165 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_165';
  ...
  async ui5_event() {
    ...
    let lo_app = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POP_ERROR", RTTIName: "\\CLASS=Z2UI5_CL_POP_ERROR"});
    let unique422 = ((await this.client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique422, new abap.types.Character(5).set('POPUP'))) {
      try {
      ...
      lo_app.set((await abap.Classes['Z2UI5_CL_POP_ERROR'].factory({x_root: lx})));
      await this.client.get().z2ui5_if_client$nav_app_call({app: lo_app});
    } else if (abap.compare.eq(unique422, new abap.types.Character(4).set('BACK'))) {
...
abap.Classes['Z2UI5_CL_DEMO_APP_165'] = z2ui5_cl_demo_app_165;
z2ui5_cl_demo_app_165.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_165.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_demo_app_165.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_165.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_demo_app_165.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_165.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_demo_app_165.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_165.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_demo_app_165};
//# sourceMappingURL=z2ui5_cl_demo_app_165.clas.mjs.map