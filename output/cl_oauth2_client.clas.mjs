  ...
  async if_oauth2_client$execute_cc_flow() {
    ...
    try {
      ...
      if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
        const unique713 = await (new abap.Classes['CX_OA2C']()).constructor_();
        unique713.EXTRA_CX = {"INTERNAL_FILENAME": "cl_oauth2_client.clas.abap","INTERNAL_LINE": 70};
        throw unique713;
      }
      ...
      try {
        ...
        if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
          const unique714 = await (new abap.Classes['CX_OA2C']()).constructor_();
          unique714.EXTRA_CX = {"INTERNAL_FILENAME": "cl_oauth2_client.clas.abap","INTERNAL_LINE": 99};
          throw unique714;
        }
        try {
          ...
          if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
            ...
            const unique715 = await (new abap.Classes['CX_OA2C']()).constructor_();
            unique715.EXTRA_CX = {"INTERNAL_FILENAME": "cl_oauth2_client.clas.abap","INTERNAL_LINE": 113};
            throw unique715;
          }
          ...
          if (abap.compare.ne(lv_code, abap.IntegerFactory.get(200))) {
            const unique716 = await (new abap.Classes['CX_OA2C']()).constructor_();
            unique716.EXTRA_CX = {"INTERNAL_FILENAME": "cl_oauth2_client.clas.abap","INTERNAL_LINE": 121};
            throw unique716;
          }
        ...
        async if_oauth2_client$set_token(INPUT) {
          ...
          if (abap.compare.initial(this.mv_token)) {
            const unique717 = await (new abap.Classes['CX_OA2C_AT_NOT_AVAILABLE']()).constructor_();
            unique717.EXTRA_CX = {"INTERNAL_FILENAME": "cl_oauth2_client.clas.abap","INTERNAL_LINE": 131};
            throw unique717;
          }
