...
// z2ui5_cl_pop_itab_json_dl.clas.abap
class z2ui5_cl_pop_itab_json_dl {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_POP_ITAB_JSON_DL';
  ...
  async factory(INPUT) {
    return z2ui5_cl_pop_itab_json_dl.factory(INPUT);
  }
  static async factory(INPUT) {
    let r_result = new abap.types.ABAPObject({qualifiedName: "Z2UI5_CL_POP_ITAB_JSON_DL", RTTIName: "\\CLASS=Z2UI5_CL_POP_ITAB_JSON_DL"});
    let itab = INPUT?.itab;
    ...
    r_result.set(await (new abap.Classes['Z2UI5_CL_POP_ITAB_JSON_DL']()).constructor_());
  ...
  async z2ui5_if_app$main(INPUT) {
    ...
    try {
      if (abap.compare.eq((await abap.Classes['Z2UI5_CL_UTIL'].rtti_check_class_exists({val: new abap.types.String().set(`z2ui5_dbt_cl_app_03`)})), abap.builtin.abap_false)) {
        ...
        await client.get().z2ui5_if_client$nav_app_leave({app: (await abap.Classes['Z2UI5_CL_POP_ERROR'].factory({x_root: lx}))});
      } else {
      ...
      if ((abap.Classes['CX_ROOT'] && e instanceof abap.Classes['CX_ROOT'])) {
        x.set(e);
        await client.get().z2ui5_if_client$nav_app_leave({app: (await abap.Classes['Z2UI5_CL_POP_TO_INFORM'].factory({i_text: (await x.get().if_message$get_text())}))});
      } else {
        throw e;
      }
    }
...
abap.Classes['Z2UI5_CL_POP_ITAB_JSON_DL'] = z2ui5_cl_pop_itab_json_dl;
z2ui5_cl_pop_itab_json_dl.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_itab_json_dl.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_pop_itab_json_dl.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_itab_json_dl.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_pop_itab_json_dl.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_itab_json_dl.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_pop_itab_json_dl.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_pop_itab_json_dl.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_pop_itab_json_dl};
//# sourceMappingURL=z2ui5_cl_pop_itab_json_dl.clas.mjs.map