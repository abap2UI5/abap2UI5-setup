...
async function run() {
  ...
  ls_input.get().class_name.set("Z2UI5_CL_AJSON");
  ls_input.get().testclass_name.set("LTCL_WRITER_TEST");
  ls_input.get().method_name.set("DELETE_");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_AJSON");
  ls_input.get().testclass_name.set("LTCL_WRITER_TEST");
  ...
  ls_input.get().method_name.set("TEST_DB_HANDLE");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_UTIL");
  ls_input.get().testclass_name.set("LTCL_TEST");
  ls_input.get().method_name.set("TEST_DB_HANDLE_READ_ID");
  abap.statements.append({source: ls_input, target: lt_input});
  await import("./z2ui5_cl_util_api.clas.testclasses.mjs");
  ls_input.get().class_name.set("Z2UI5_CL_UTIL_API");
  ...
  ls_input.get().class_name.set("Z2UI5_CL_UTIL_STMPNCFCTN");
  ls_input.get().testclass_name.set("LTCL_TEST");
  ...
  ls_input.get().class_name.set("Z2UI5_CL_CORE_DISSOLVE_SRV");
  ...
  ls_input.get().class_name.set("Z2UI5_CL_CORE_HTTP_GET");
  ls_input.get().testclass_name.set("LTCL_TEST_HTTP_GET");
  ls_input.get().method_name.set("FILE_NOT_INITIAL");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_CORE_HTTP_GET");
  ls_input.get().testclass_name.set("LTCL_TEST_HTTP_GET");
  ls_input.get().method_name.set("LAUNCHPAD_COMPATIBILITY");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_CORE_HTTP_GET");
  ls_input.get().testclass_name.set("LTCL_TEST_HTTP_GET");
  ls_input.get().method_name.set("PATH_SETUP");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_CORE_HTTP_GET");
  ls_input.get().testclass_name.set("LTCL_TEST_HTTP_GET");
  ls_input.get().method_name.set("JS_NO_DEBUGGER");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_CORE_HTTP_GET");
  ls_input.get().testclass_name.set("LTCL_TEST_HTTP_GET");
  ls_input.get().method_name.set("JS_NO_SAP_UI_GET_CORE");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_CORE_HTTP_GET");
  ls_input.get().testclass_name.set("LTCL_TEST_HTTP_GET");
  ls_input.get().method_name.set("JS_NO_WINDOW");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_CORE_HTTP_GET");
  ls_input.get().testclass_name.set("LTCL_TEST_HTTP_GET");
  ls_input.get().method_name.set("JS_NO_DOCUMENT");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_CORE_HTTP_GET");
  ls_input.get().testclass_name.set("LTCL_TEST_HTTP_GET");
  ls_input.get().method_name.set("BOOTSTRAP_WITH_OPEN_UI5");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_CORE_HTTP_GET");
  ls_input.get().testclass_name.set("LTCL_TEST_HTTP_GET");
  ls_input.get().method_name.set("JS_NO_JQUERY");
  abap.statements.append({source: ls_input, target: lt_input});
  ...
  ls_input.get().class_name.set("Z2UI5_CL_CORE_APP_ERROR");
  ls_input.get().testclass_name.set("LTCL_APP_ERROR_TEST");
  ls_input.get().method_name.set("FIRST_TEST");
  abap.statements.append({source: ls_input, target: lt_input});
  await import("./z2ui5_cl_core_app_info.clas.testclasses.mjs");
  ls_input.get().class_name.set("Z2UI5_CL_CORE_APP_INFO");
  ls_input.get().testclass_name.set("LTCL_APP_STARTUP_TEST");
  ls_input.get().method_name.set("FIRST_TEST");
  abap.statements.append({source: ls_input, target: lt_input});
  await import("./z2ui5_cl_core_app_search.clas.testclasses.mjs");
  ls_input.get().class_name.set("Z2UI5_CL_CORE_APP_SEARCH");
  ls_input.get().testclass_name.set("LTCL_UNIT_TEST");
  ls_input.get().method_name.set("FIRST_TEST");
  abap.statements.append({source: ls_input, target: lt_input});
  ...
  ls_input.get().class_name.set("Z2UI5_CL_TEST_INTEGRATION_TEST");
  ls_input.get().testclass_name.set("LTCL_UNIT_TEST");
  ls_input.get().method_name.set("FIRST_TEST");
  abap.statements.append({source: ls_input, target: lt_input});
  ...
  ls_input.get().class_name.set("Z2UI5_CL_UI5");
  ls_input.get().testclass_name.set("LTCL_UNIT_TEST");
  ls_input.get().method_name.set("TEST_FACTORY");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_UI5");
  ls_input.get().testclass_name.set("LTCL_UNIT_TEST");
  ls_input.get().method_name.set("TEST_FACTORY_POPUP");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_UI5");
  ls_input.get().testclass_name.set("LTCL_UNIT_TEST");
  ls_input.get().method_name.set("TEST_ADD");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_UI5");
  ls_input.get().testclass_name.set("LTCL_UNIT_TEST");
  ls_input.get().method_name.set("TEST_ADD_P");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_UI5");
  ls_input.get().testclass_name.set("LTCL_UNIT_TEST");
  ls_input.get().method_name.set("TEST_NS");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_UI5");
  ls_input.get().testclass_name.set("LTCL_UNIT_TEST");
  ls_input.get().method_name.set("TEST_ADD_ADD");
  abap.statements.append({source: ls_input, target: lt_input});
  await import("./z2ui5_cl_http_handler.clas.testclasses.mjs");
  ls_input.get().class_name.set("Z2UI5_CL_HTTP_HANDLER");
  ls_input.get().testclass_name.set("LTCL_UNIT_TEST");
  ls_input.get().method_name.set("TEST_GET");
  abap.statements.append({source: ls_input, target: lt_input});
  ls_input.get().class_name.set("Z2UI5_CL_HTTP_HANDLER");
  ls_input.get().testclass_name.set("LTCL_UNIT_TEST");
  ls_input.get().method_name.set("TEST_POST");
  abap.statements.append({source: ls_input, target: lt_input});
