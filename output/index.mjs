...
// --------------------------------------------
    ...
    {
        const {ltcl_test_app} = await import("./z2ui5_cl_util.clas.testclasses.mjs");
...
// --------------------------------------------
    clas = unit.addObject("Z2UI5_CL_ABAP_API");
    {
        const {ltcl_test} = await import("./z2ui5_cl_abap_api.clas.testclasses.mjs");
        ...
        if (ltcl_test.class_setup) await ltcl_test.class_setup();
      {
        ...
        console.log("Z2UI5_CL_ABAP_API: running ltcl_test->test_func_get_uuid_32");
      ...
      }
      {
        const test = await (new ltcl_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_ABAP_API: running ltcl_test->test_func_get_uuid_22");
      ...
      }
      {
        const test = await (new ltcl_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_ABAP_API: running ltcl_test->test_encoding");
      ...
      }
      {
        const test = await (new ltcl_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_ABAP_API: running ltcl_test->test_element_text");
      ...
      }
      {
        const test = await (new ltcl_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_ABAP_API: running ltcl_test->test_classes_impl_intf");
...
// --------------------------------------------
    clas = unit.addObject("Z2UI5_CL_AJSON");
    {
      ...
      }
      {
        const test = await (new ltcl_json_to_abap()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_AJSON: running ltcl_json_to_abap->to_abap_str_to_packed");
        meth = locl.addMethod("to_abap_str_to_packed");
        await test.to_abap_str_to_packed();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
      {
        const test = await (new ltcl_json_to_abap()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_AJSON: running ltcl_json_to_abap->to_abap_compressed_stdrd");
        meth = locl.addMethod("to_abap_compressed_stdrd");
        await test.to_abap_compressed_stdrd();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
      {
        const test = await (new ltcl_json_to_abap()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_AJSON: running ltcl_json_to_abap->to_abap_compressed_stdrd_key");
        meth = locl.addMethod("to_abap_compressed_stdrd_key");
        await test.to_abap_compressed_stdrd_key();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
      {
        const test = await (new ltcl_json_to_abap()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_AJSON: running ltcl_json_to_abap->to_abap_compressed_sort");
        meth = locl.addMethod("to_abap_compressed_sort");
        await test.to_abap_compressed_sort();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
      {
        const test = await (new ltcl_json_to_abap()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_AJSON: running ltcl_json_to_abap->to_abap_compressed_sort_unique");
        meth = locl.addMethod("to_abap_compressed_sort_unique");
        await test.to_abap_compressed_sort_unique();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
      {
        const test = await (new ltcl_json_to_abap()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_AJSON: running ltcl_json_to_abap->to_abap_compressed_hash");
        meth = locl.addMethod("to_abap_compressed_hash");
        await test.to_abap_compressed_hash();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
...
// --------------------------------------------
    clas = unit.addObject("Z2UI5_CL_AJSON");
    {
      ...
      }
      {
        const test = await (new ltcl_writer_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_AJSON: running ltcl_writer_test->delete");
      ...
      }
      {
        const test = await (new ltcl_writer_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_AJSON: running ltcl_writer_test->new_array_w_keep_order_touch");
        meth = locl.addMethod("new_array_w_keep_order_touch");
        await test.new_array_w_keep_order_touch();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
      {
...
// --------------------------------------------
    clas = unit.addObject("Z2UI5_CL_CORE_ATTRI_SRV");
    {
        const {ltcl_test_get_attri} = await import("./z2ui5_cl_core_attri_srv.clas.testclasses.mjs");
        locl = clas.addTestClass("ltcl_test_get_attri");
        if (ltcl_test_get_attri.class_setup) await ltcl_test_get_attri.class_setup();
      {
        const test = await (new ltcl_test_get_attri()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_ATTRI_SRV: running ltcl_test_get_attri->first_test");
        meth = locl.addMethod("first_test");
        await test.first_test();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
      {
        const test = await (new ltcl_test_get_attri()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_ATTRI_SRV: running ltcl_test_get_attri->second_test");
        meth = locl.addMethod("second_test");
        await test.second_test();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
      {
        const test = await (new ltcl_test_get_attri()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_ATTRI_SRV: running ltcl_test_get_attri->third_test");
        meth = locl.addMethod("third_test");
        await test.third_test();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
      {
        const test = await (new ltcl_test_get_attri()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_ATTRI_SRV: running ltcl_test_get_attri->test4");
        meth = locl.addMethod("test4");
        await test.test4();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
      if (ltcl_test_get_attri.class_teardown) await ltcl_test_get_attri.class_teardown();
    }
// --------------------------------------------
    clas = unit.addObject("Z2UI5_CL_CORE_DISS_SRV");
    {
        const {ltcl_test_dissolve} = await import("./z2ui5_cl_core_diss_srv.clas.testclasses.mjs");
        ...
        if (ltcl_test_dissolve.class_setup) await ltcl_test_dissolve.class_setup();
      {
        ...
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_DISS_SRV: running ltcl_test_dissolve->test_init");
      ...
      }
      {
        const test = await (new ltcl_test_dissolve()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_DISS_SRV: running ltcl_test_dissolve->test_struc");
      ...
      }
      {
        const test = await (new ltcl_test_dissolve()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_DISS_SRV: running ltcl_test_dissolve->test_dref");
      ...
      }
      {
        const test = await (new ltcl_test_dissolve()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_DISS_SRV: running ltcl_test_dissolve->test_struc_dref");
      ...
      }
      {
        const test = await (new ltcl_test_dissolve()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_DISS_SRV: running ltcl_test_dissolve->test_oref");
      ...
      }
      {
        const test = await (new ltcl_test_dissolve()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_DISS_SRV: running ltcl_test_dissolve->test_ref");
      ...
      }
      {
        const test = await (new ltcl_test_dissolve()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_DISS_SRV: running ltcl_test_dissolve->test_oref_dref_struc");
      ...
      }
      {
        const test = await (new ltcl_test_dissolve()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_DISS_SRV: running ltcl_test_dissolve->test_oref_dref");
      ...
      }
      {
        const test = await (new ltcl_test_dissolve()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_DISS_SRV: running ltcl_test_dissolve->test_dref_struc");
...
// --------------------------------------------
    clas = unit.addObject("Z2UI5_CL_UTIL");
    {
        const {ltcl_unit_test_abap_api} = await import("./z2ui5_cl_util.clas.testclasses.mjs");
        ...
        if (ltcl_unit_test_abap_api.class_setup) await ltcl_unit_test_abap_api.class_setup();
      {
        ...
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test_abap_api->test_assign");
      ...
      }
      {
        const test = await (new ltcl_unit_test_abap_api()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test_abap_api->test_eledescr_rel_name");
      ...
      }
      {
        const test = await (new ltcl_unit_test_abap_api()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test_abap_api->test_classdescr");
      ...
      }
      {
        const test = await (new ltcl_unit_test_abap_api()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test_abap_api->test_substring_after");
      ...
      }
      {
        const test = await (new ltcl_unit_test_abap_api()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test_abap_api->test_substring_before");
      ...
      }
      {
        const test = await (new ltcl_unit_test_abap_api()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test_abap_api->test_string_shift");
      ...
      }
      {
        const test = await (new ltcl_unit_test_abap_api()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test_abap_api->test_string_replace");
      ...
      }
      {
        const test = await (new ltcl_unit_test_abap_api()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test_abap_api->test_raise_error");
      ...
      }
      {
        const test = await (new ltcl_unit_test_abap_api()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test_abap_api->test_xsdbool");
      ...
      }
      {
        const test = await (new ltcl_unit_test_abap_api()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test_abap_api->test_xsdbool_nested");
...
// --------------------------------------------
    clas = unit.addObject("Z2UI5_CL_CORE_ATTRI_SRV");
    {
        const {ltcl_test_app_sub} = await import("./z2ui5_cl_core_attri_srv.clas.testclasses.mjs");
        locl = clas.addTestClass("ltcl_test_app_sub");
        if (ltcl_test_app_sub.class_setup) await ltcl_test_app_sub.class_setup();
      if (ltcl_test_app_sub.class_teardown) await ltcl_test_app_sub.class_teardown();
    }
// --------------------------------------------
    clas = unit.addObject("Z2UI5_CL_CORE_ATTRI_SRV");
    {
        const {ltcl_test_app3} = await import("./z2ui5_cl_core_attri_srv.clas.testclasses.mjs");
        locl = clas.addTestClass("ltcl_test_app3");
        if (ltcl_test_app3.class_setup) await ltcl_test_app3.class_setup();
      if (ltcl_test_app3.class_teardown) await ltcl_test_app3.class_teardown();
    }
// --------------------------------------------
...
// --------------------------------------------
    clas = unit.addObject("Z2UI5_CL_CORE_BIND_SRV");
    {
      ...
      }
      {
        const test = await (new ltcl_test_bind()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_CORE_BIND_SRV: running ltcl_test_bind->test_local_one");
        meth = locl.addMethod("test_local_one");
        await test.test_local_one();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
...
// --------------------------------------------
    clas = unit.addObject("Z2UI5_CL_UTIL");
    {
        const {ltcl_unit_test} = await import("./z2ui5_cl_util.clas.testclasses.mjs");
        ...
        if (ltcl_unit_test.class_setup) await ltcl_unit_test.class_setup();
      {
        ...
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_create");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_boolean_abap_2_json");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_boolean_check");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_c_trim");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_c_trim_lower");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_c_trim_upper");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_c_trim_horizontal_tab");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_time_get_timestampl");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_time_substract_seconds");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_func_get_user_tech");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_rtti_get_t_attri_by_incl");
        meth = locl.addMethod("test_rtti_get_t_attri_by_incl");
        await test.test_rtti_get_t_attri_by_incl();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_rtti_get_classname_by_ref");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_rtti_get_type_name");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_rtti_get_type_kind");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_rtti_check_type_kind");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_rtti_get_t_attri_by_obj");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_rtti_get_t_comp_by_struc");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_trans_json_any_2__w_struc");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_trans_xml_any_2__w_obj");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_trans_xml_any_2__w_data");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_trans_xml_2_any__w_obj");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_trans_xml_2_any__w_data");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_url_param_create_url");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_url_param_get");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_url_param_get_tab");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_url_param_set");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_x_check_raise");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_x_check_raise_not");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_x_raise");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_check_unassign_inital");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->conv_copy_ref_data");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->rtti_check_ref_data");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_check_bound_a_not_inital");
      ...
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_sql_get_by_string");
        meth = locl.addMethod("test_sql_get_by_string");
        await test.test_sql_get_by_string();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CL_UTIL: running ltcl_unit_test->test_get_token_t_by_r_t");
        meth = locl.addMethod("test_get_token_t_by_r_t");
        await test.test_get_token_t_by_r_t();
        meth.pass();
        if (test.teardown) await test.teardown();
      }
...
// --------------------------------------------
    clas = unit.addObject("Z2UI5_CX_ABAP_API");
    {
        const {ltcl_unit_test} = await import("./z2ui5_cx_abap_api.clas.testclasses.mjs");
        locl = clas.addTestClass("ltcl_unit_test");
        if (ltcl_unit_test.class_setup) await ltcl_unit_test.class_setup();
      {
        const test = await (new ltcl_unit_test()).constructor_();
        if (test.setup) await test.setup();
        console.log("Z2UI5_CX_ABAP_API: running ltcl_unit_test->test_raise");
