...
class cl_oa2c_config_writer_api {
  ...
  static async load(INPUT) {
    ...
    if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
      const unique712 = await (new abap.Classes['CX_OA2C_CONFIG_NOT_FOUND']()).constructor_();
      unique712.EXTRA_CX = {"INTERNAL_FILENAME": "cl_oa2c_config_writer_api.clas.abap","INTERNAL_LINE": 85};
      throw unique712;
    }
    ro_config_writer_api.set(await (new abap.Classes['CL_OA2C_CONFIG_WRITER_API']()).constructor_());
