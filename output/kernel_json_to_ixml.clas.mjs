  ...
  static async build(INPUT) {
    ...
    while (true) {
      ...
      if (abap.compare.eq(unique697, abap.Classes['IF_SXML_NODE'].if_sxml_node$co_nt_element_open)) {
        ...
        for await (const unique698 of abap.statements.loop(lt_attributes)) {
          li_attribute.set(unique698);
