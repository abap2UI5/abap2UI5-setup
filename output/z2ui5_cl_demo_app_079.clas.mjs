...
// z2ui5_cl_demo_app_079.clas.abap
class z2ui5_cl_demo_app_079 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_079';
  ...
  static METHODS = {"GET_EXAMPLE_PDF": {"visibility": "U", "parameters": {"RESULT": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}}}};
  constructor() {
  ...
  async z2ui5_if_app$main(INPUT) {
    ...
    if (abap.compare.eq(this.check_initialized, abap.builtin.abap_false)) {
      ...
      temp2.get().v.set((await this.get_example_pdf()));
      abap.statements.insertInternal({data: temp2, table: temp1});
      temp2.get().n.set(new abap.types.String().set(`height`));
      temp2.get().v.set(new abap.types.String().set(`90%`));
      abap.statements.insertInternal({data: temp2, table: temp1});
      temp2.get().n.set(new abap.types.String().set(`width`));
      temp2.get().v.set(new abap.types.String().set(`90%`));
      abap.statements.insertInternal({data: temp2, table: temp1});
      view.set((await (await (await (await abap.Classes['Z2UI5_CL_XML_VIEW'].factory()).get().shell()).get().page({title: new abap.types.Character(10).set('PDF Output'), navbuttonpress: (await client.get().z2ui5_if_client$_event({val: new abap.types.Character(4).set('BACK')})), shownavbutton: abap.builtin.abap_true})).get()._generic({ns: new abap.types.String().set(`html`), name: new abap.types.String().set(`iframe`), t_prop: temp1})));
      await client.get().z2ui5_if_client$view_display({val: (await view.get().stringify())});
    }
    let unique304 = ((await client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique304, new abap.types.Character(4).set('BACK'))) {
...
abap.Classes['Z2UI5_CL_DEMO_APP_079'] = z2ui5_cl_demo_app_079;
z2ui5_cl_demo_app_079.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_079.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_demo_app_079.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_079.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_demo_app_079.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_079.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_demo_app_079.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_079.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_demo_app_079};
//# sourceMappingURL=z2ui5_cl_demo_app_079.clas.mjs.map