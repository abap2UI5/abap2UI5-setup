...
class z2ui5_if_app {
  ...
  "CHECK_STICKY": {"type": () => {return new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"});}, "visibility": "U", "is_constant": " ", "is_class": " "},
  ...
  "AUTHOR": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "visibility": "U", "is_constant": "X", "is_class": "X"},
...
z2ui5_if_app.z2ui5_if_app$version.set('1.135.0');
...
z2ui5_if_app.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_if_app.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
