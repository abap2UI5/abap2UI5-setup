...
class zcl_sicf {
  ...
  async if_http_extension$handle_request(INPUT) {
    ...
    let unique173 = lv_method;
    if (abap.compare.eq(unique173, new abap.types.Character(3).set('GET'))) {
      lv_resp.set((await abap.Classes['Z2UI5_CL_HTTP_HANDLER'].http_get()));
    } else if (abap.compare.eq(unique173, new abap.types.Character(4).set('POST'))) {
