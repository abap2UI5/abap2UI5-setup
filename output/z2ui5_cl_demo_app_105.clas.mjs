...
// z2ui5_cl_demo_app_105.clas.abap
class z2ui5_cl_demo_app_105 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_105';
  ...
  "MV_CLASS_1": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "visibility": "U", "is_constant": " ", "is_class": " "},
  ...
  constructor() {
    ...
    this.mv_class_1 = new abap.types.String({qualifiedName: "STRING"});
  ...
  async display_view(INPUT) {
    ...
    await this.mo_view_parent.get().input({value: (await this.client.get().z2ui5_if_client$_bind_edit({val: this.mv_class_1})), placeholder: new abap.types.String().set(`Input From Class 1`)});
  }
  async on_event() {
    let unique338 = ((await this.client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique338, new abap.types.Character(11).set('MESSAGE_SUB'))) {
...
abap.Classes['Z2UI5_CL_DEMO_APP_105'] = z2ui5_cl_demo_app_105;
z2ui5_cl_demo_app_105.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_105.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_demo_app_105.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_105.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_demo_app_105.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_105.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_demo_app_105.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_105.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_demo_app_105};
//# sourceMappingURL=z2ui5_cl_demo_app_105.clas.mjs.map