...
// z2ui5_cl_demo_app_284.clas.abap
class z2ui5_cl_demo_app_284 {
  static INTERNAL_TYPE = 'CLAS';
  static INTERNAL_NAME = 'Z2UI5_CL_DEMO_APP_284';
  ...
  async display_view(INPUT) {
    ...
    page_01.set((await (await (await abap.Classes['Z2UI5_CL_XML_VIEW'].factory()).get().shell()).get().page({title: new abap.types.Character(44).set('abap2UI5 - Sample: Flexible sizing - Toolbar'), navbuttonpress: (await client.get().z2ui5_if_client$_event({val: new abap.types.Character(4).set('BACK')})), shownavbutton: temp1})));
  ...
  async on_event(INPUT) {
    ...
    if (client?.getQualifiedName === undefined || client.getQualifiedName() !== "Z2UI5_IF_CLIENT") { client = undefined; }
    if (client === undefined) { client = new abap.types.ABAPObject({qualifiedName: "Z2UI5_IF_CLIENT", RTTIName: "\\INTERFACE=Z2UI5_IF_CLIENT"}).set(INPUT.client); }
    let unique581 = ((await client.get().z2ui5_if_client$get())).get().event;
    if (abap.compare.eq(unique581, new abap.types.Character(4).set('BACK'))) {
      await client.get().z2ui5_if_client$nav_app_leave();
    } else if (abap.compare.eq(unique581, new abap.types.Character(15).set('CLICK_HINT_ICON'))) {
...
abap.Classes['Z2UI5_CL_DEMO_APP_284'] = z2ui5_cl_demo_app_284;
z2ui5_cl_demo_app_284.z2ui5_if_app$version = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_284.z2ui5_if_app$version.set('1.135.0');
z2ui5_cl_demo_app_284.z2ui5_if_app$origin = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_284.z2ui5_if_app$origin.set('https://github.com/abap2UI5/abap2UI5');
z2ui5_cl_demo_app_284.z2ui5_if_app$author = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_284.z2ui5_if_app$author.set('https://github.com/oblomov-dev');
z2ui5_cl_demo_app_284.z2ui5_if_app$license = new abap.types.String({qualifiedName: "STRING"});
z2ui5_cl_demo_app_284.z2ui5_if_app$license.set('MIT');
export {z2ui5_cl_demo_app_284};
//# sourceMappingURL=z2ui5_cl_demo_app_284.clas.mjs.map