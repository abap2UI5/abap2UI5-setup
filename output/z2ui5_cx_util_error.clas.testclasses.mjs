...
class ltcl_unit_test {
  ...
  async test_raise() {
    ...
    try {
      const unique102 = await (new abap.Classes['Z2UI5_CX_UTIL_ERROR']()).constructor_({val: new abap.types.String().set(`this is an error text`)});
      unique102.EXTRA_CX = {"INTERNAL_FILENAME": "z2ui5_cx_util_error.clas.testclasses.abap","INTERNAL_LINE": 17};
      throw unique102;
    } catch (e) {
